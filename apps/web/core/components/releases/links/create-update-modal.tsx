...
export function CreateUpdateReleaseLinkModal(props: Props) {
    ...
    try {
      if (!data) {
        ...
        setToast({
          ...
          title: "Success!",
          message: "Release link created successfully.",
        });
      } else {
        ...
        setToast({
          type: TOAST_TYPE.SUCCESS,
          title: "Success!",
          message: "Release link updated successfully.",
        });
      }
      onClose();
    } catch (error: any) {
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)}>
        <div className="space-y-5 p-5">
          ...
          <div className="mt-2 space-y-3">
            <div>
              <label htmlFor="release-link-url" className="mb-2 text-secondary">
                URL
              </label>
              <Controller
                control={control}
            ...
            <div>
              <label htmlFor="release-link-title" className="mb-2 text-secondary">
                Display title
