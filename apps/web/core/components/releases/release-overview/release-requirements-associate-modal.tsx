...
export const ReleaseRequirementsAssociateModal = (props: TProps) => {
  const { isOpen, workspaceSlug, projectId, releaseId, handleClose: onClose, onSubmit } = props;
  ...
  const fetchRows = useCallback(
    ...
    [debouncedSearchTerm, isOpen, projectId, releaseId, workspaceSlug]
  );
  ...
  return (
    <ModalCore isOpen={isOpen} handleClose={handleClose} position={EModalPosition.CENTER} width={EModalWidth.XXXL}>
      ...
      >
        ...
        {/* 已选区：与项目侧关联弹窗一致，选中项以可撤销的胶囊常驻在搜索框下方 */}
