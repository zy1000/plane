...
import { STAGE_REVIEW_DISPLAY_PROPERTIES, STAGE_REVIEW_GROUP_BY, STAGE_REVIEW_ORDER_BY } from "./display-settings";
    ...
    >
      <div className="vertical-scrollbar relative scrollbar-sm h-full w-full divide-y divide-subtle-1 overflow-hidden overflow-y-auto px-2.5">
        <div className="py-2">
          ...
          {isPropertiesOpen && (
            <div className="mt-1 flex flex-wrap items-center gap-2">
              {STAGE_REVIEW_DISPLAY_PROPERTIES.map((property) => {
        ...
        <div className="py-2">
          ...
          />
          {isGroupOpen &&
            STAGE_REVIEW_GROUP_BY.map((groupBy) => (
              <FilterOption
                key={groupBy}
