...
import { ReleasesTimeLineStore } from "@/store/timeline/releases-timeline.store";
import type { IReleasesTimeLineStore } from "@/store/timeline/releases-timeline.store";
...
export interface ITimelineStore {
  ...
  releasesTimeLineStore: IReleasesTimeLineStore;
...
export class TimeLineStore implements ITimelineStore {
  ...
  constructor(rootStore: RootStore) {
    ...
    this.releasesTimeLineStore = new ReleasesTimeLineStore(rootStore);
    // Dummy store
