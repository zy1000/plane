...
import { CORE_OPERATORS, EXTENDED_EQUALITY_OPERATOR } from "@plane/types";
...
export const useFiltersOperatorConfigs = (_props: TUseFiltersOperatorConfigsProps): TFiltersOperatorConfigs => ({
  allowedOperators: new Set([...Object.values(CORE_OPERATORS), EXTENDED_EQUALITY_OPERATOR.CONTAINS]),
  allowNegative: false,
});
