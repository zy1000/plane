...
export const coreRoutes: RouteConfigEntry[] = [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(projects)/products/layout.tsx", [
          ...
          layout("./(all)/[workspaceSlug]/(projects)/products/[productId]/layout.tsx", [
            ...
            route(
              ":workspaceSlug/products/:productId/stage-reviews",
              "./(all)/[workspaceSlug]/(projects)/products/[productId]/stage-reviews/page.tsx"
            ),
            route(
        ...
        layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/layout.tsx", [
          ...
          layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/cycles/(detail)/layout.tsx", [
            ...
            route(
              ...
              "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/cycles/(attachments)/[cycleId]/page.tsx"
            ),
            route(
          ...
          route(
            ":workspaceSlug/projects/:projectId/filestore/xmind/:assetId",
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/filestore/xmind/[assetId]/page.tsx"
          ),
          ...
          layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/testhub/layout.tsx", [
            ...
            route(
              ":workspaceSlug/projects/:projectId/testhub/cases/mind",
              "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/testhub/cases/mind/page.tsx"
            ),
            route(
      ...
      layout("./(all)/[workspaceSlug]/(settings)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/(workspace)/layout.tsx", [
          ...
          route(
            ...
            "./(all)/[workspaceSlug]/(settings)/settings/(workspace)/my-access/page.tsx"
          ),
          route(
          ...
          route(
            ...
            "./(all)/[workspaceSlug]/(settings)/settings/(workspace)/groups/page.tsx"
          ),
          route(
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/projects/layout.tsx", [
          ...
          layout("./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/layout.tsx", [
            ...
            route(
              ...
              "./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/roles/page.tsx"
            ),
            // Project Features
            route(
  ...
  // Timesheets: 旧路径 /timesheets/fill → /timesheets
