# Generated by Django 4.2.24 on 2025-12-15 08:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='workspace',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner_workspace', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='workspace',
            name='slug',
        ...
        migrations.AlterField(
            model_name='workspacehomepreference',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workspace_user_home_preferences', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='workspacehomepreference',
            name='workspace',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workspace_user_home_preferences', to='db.workspace'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='workspacemember',
            name='member',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='member_workspace', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='workspacemember',
            name='role',
        ...
        migrations.AlterField(
            model_name='workspacemember',
            name='workspace',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workspace_member', to='db.workspace'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='workspacememberinvite',
            name='workspace',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workspace_member_invite', to='db.workspace'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='workspacetheme',
            name='workspace',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='themes', to='db.workspace'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='workspaceuserlink',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner_workspace_user_link', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='workspaceuserlink',
            name='project',
        ...
        migrations.AlterField(
            ...
            field=models.JSONField(default=plane.db.models.workspace.get_default_display_filters),
        ),
        migrations.AlterField(
            model_name='workspaceuserproperties',
            name='display_properties',
            field=models.JSONField(default=plane.db.models.workspace.get_default_display_properties),
        ),
        migrations.AlterField(
            model_name='workspaceuserproperties',
            name='filters',
            field=models.JSONField(default=plane.db.models.workspace.get_default_filters),
        ),
        migrations.AlterField(
            model_name='workspaceuserproperties',
            name='rich_filters',
        ...
        migrations.AlterField(
            model_name='workspaceuserproperties',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workspace_user_properties', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='workspaceuserproperties',
            name='workspace',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workspace_user_properties', to='db.workspace'),
        ),
    ]
