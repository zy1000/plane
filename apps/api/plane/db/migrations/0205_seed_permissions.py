...
issue.create|创建工作项|project|issue|create|工作项主体|1|1
issue.edit|编辑工作项|project|issue|edit|工作项主体|2|1
issue.delete|删除工作项|project|issue|delete|工作项主体|3|1
issue.archive|归档工作项|project|issue|archive|工作项主体|4|1
issue.unarchive|恢复工作项|project|issue|unarchive|工作项主体|5|1
...
intake.view|查看需求收集列表与详情|project|intake|view|需求收集|1|1
intake.create|创建需求收集|project|intake|create|需求收集|2|1
intake.edit|编辑需求收集|project|intake|edit|需求收集|3|1
intake.delete|删除需求收集|project|intake|delete|需求收集|4|1
intake.issue.view|查看需求收集工作项|project|intake.issue|view|需求收集|5|1
intake.issue.create|创建需求收集工作项|project|intake.issue|create|需求收集|6|1
intake.issue.edit|编辑需求收集工作项|project|intake.issue|edit|需求收集|7|1
intake.issue.delete|删除需求收集工作项|project|intake.issue|delete|需求收集|8|1
intake.description_version.view|查看需求收集描述版本|project|intake.description_version|view|需求收集|9|1
...
workflow.transition.view|查看流转定义|project|workflow.transition|view|工作流流转|1|1
workflow.transition.create|创建流转|project|workflow.transition|create|工作流流转|2|1
workflow.transition.edit|编辑流转|project|workflow.transition|edit|工作流流转|3|1
workflow.transition.delete|删除流转|project|workflow.transition|delete|工作流流转|4|1
workflow.approval.view|查看我的审批/审批记录|project|workflow.approval|view|工作流审批|1|1
workflow.approval.action|审批通过、拒绝、处理审批动作|project|workflow.approval|action|工作流审批|2|1
workflow.transition_record.view|查看工作项流转记录|project|workflow.transition_record|view|工作流流转记录|1|1
...
filestore.view|查看项目文件库|project|filestore|view|项目文件库|1|1
filestore.upload|上传文件库文件|project|filestore|upload|项目文件库|2|1
filestore.edit|编辑文件库文件|project|filestore|edit|项目文件库|3|1
filestore.delete|删除文件库文件|project|filestore|delete|项目文件库|4|1
filestore.download|下载文件库文件|project|filestore|download|项目文件库|5|1
filestore.restore_version|恢复历史版本|project|filestore|restore_version|项目文件库|6|1
qa.case.view|查看测试用例|project|qa.case|view|测试|1|1
qa.case.create|创建测试用例|project|qa.case|create|测试|2|1
qa.case.edit|编辑测试用例|project|qa.case|edit|测试|3|1
qa.case.delete|删除测试用例|project|qa.case|delete|测试|4|1
qa.case.import_export|导入/导出测试用例|project|qa.case|import_export|测试|5|1
qa.plan.view|查看测试计划|project|qa.plan|view|测试|6|1
