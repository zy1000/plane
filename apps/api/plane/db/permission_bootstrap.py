...
MODULE_LABELS = {
    ...
    "project.review_tailoring": "裁剪表",
    "project.stage_review": "阶段评审",
...
PERMISSION_OVERRIDES = {
    ...
    # 模板中心：module / category 用工作区侧的短名口径（迁移 0359 有一份副本，改这里要同步）
