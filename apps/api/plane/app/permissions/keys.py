...
class PermissionKey(str, Enum):
    ...
    PROJECT_ANNOUNCEMENT_VIEW = "project.announcement.view"
    ...
    ISSUE_LINK_VIEW = "issue.link.view"
    ISSUE_LINK_MANAGE = "issue.link.manage"
    ISSUE_RELATION_VIEW = "issue.relation.view"
    ...
    ISSUE_LABEL_MANAGE = "issue.label.manage"
    ...
    RELEASES_SPRINTS_MANAGE = "releases.sprints.manage"
    PAGE_VIEW = "page.view"
    ...
    WORKFLOW_TRANSITION_VIEW = "workflow.transition.view"
    WORKFLOW_TRANSITION_CREATE = "workflow.transition.create"
    WORKFLOW_TRANSITION_EDIT = "workflow.transition.edit"
    WORKFLOW_TRANSITION_DELETE = "workflow.transition.delete"
    WORKFLOW_APPROVAL_VIEW = "workflow.approval.view"
    WORKFLOW_APPROVAL_ACTION = "workflow.approval.action"
    WORKFLOW_TRANSITION_RECORD_VIEW = "workflow.transition_record.view"
    PROJECT_ANALYTICS_VIEW = "project.analytics.view"
    PROJECT_ANALYTICS_ADVANCED_VIEW = "project.analytics.advanced_view"
    SEARCH_ISSUE_VIEW = "search.issue.view"
    ...
    FILESTORE_VIEW = "filestore.view"
    FILESTORE_UPLOAD = "filestore.upload"
    FILESTORE_EDIT = "filestore.edit"
    FILESTORE_DELETE = "filestore.delete"
    FILESTORE_DOWNLOAD = "filestore.download"
    FILESTORE_RESTORE_VERSION = "filestore.restore_version"
