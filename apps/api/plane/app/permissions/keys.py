...
class PermissionKey(str, Enum):
    ...
    ISSUE_DEFECT_ARCHIVE = "issue.defect.archive"
    ISSUE_DEFECT_UNARCHIVE = "issue.defect.unarchive"
    ISSUE_REQUIREMENT_CREATE = "issue.requirement.create"
    ISSUE_REQUIREMENT_EDIT = "issue.requirement.edit"
    ISSUE_REQUIREMENT_DELETE = "issue.requirement.delete"
    ISSUE_REQUIREMENT_ARCHIVE = "issue.requirement.archive"
    ISSUE_REQUIREMENT_UNARCHIVE = "issue.requirement.unarchive"
    ISSUE_TASK_CREATE = "issue.task.create"
    ISSUE_TASK_EDIT = "issue.task.edit"
    ISSUE_TASK_DELETE = "issue.task.delete"
    ISSUE_TASK_ARCHIVE = "issue.task.archive"
    ISSUE_TASK_UNARCHIVE = "issue.task.unarchive"
