...
export type TEditorAssetType =
  ...
  | EFileAssetType.PRODUCT_DESCRIPTION
  | EFileAssetType.REQUIREMENT_ATTACHMENT
  | EFileAssetType.REQUIREMENT_COMMENT_DESCRIPTION
  | EFileAssetType.TEAM_SPACE_COMMENT_DESCRIPTION
  | EFileAssetType.CYCLE_COMMENT_DESCRIPTION
  | EFileAssetType.RELEASE_COMMENT_DESCRIPTION
  | EFileAssetType.TEST_CASE_COMMENT_DESCRIPTION;
