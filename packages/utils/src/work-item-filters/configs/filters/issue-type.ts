// plane imports
import { COLLECTION_OPERATOR, EQUALITY_OPERATOR, type TFilterProperty } from "@plane/types";
// local imports
import {
  createFilterConfig,
  getMultiSelectConfig,
  type IFilterIconConfig,
  type TCreateFilterConfig,
  type TCreateFilterConfigParams,
