...
export default {
  ...
  requirement_fields: {
    ...
    field_categories: {
      ...
      standard_hint: "Shown in both the library and product requirements",
      data: "Data field",
      data_hint: "Shown only in product requirements, hidden in the library",
      inherited: "Inherited from the parent form",
      required: "Pick a category for every field.",
    },
    field_types: {
      text: "Text",
      member: "Member",
  ...
  project_requirements: {
    ...
    filtered_empty: {
      ...
      description: "Try another product, stage or type, or clear the search term.",
    },
    columns: "Columns",
    all_types: "All types",
    title: "Requirements",
    ...
    unlink_confirm: {
      ...
      description:
        "Unlinks {count} requirement(s) from this project. They stay in their product and are not deleted; the stage recorded in this project will be cleared.",
    },
    stage: {
      linked: "Linked",
      planned: "Planned",
    ...
    stage_carryover: "Cycle ended",
    stage_reason: {
      linked: "Linked to this project",
      planned: "Scheduled in cycle {name}",
      in_progress: "Derived from work items",
      done: "Derived from work items",
      pending_verification: "Added to release {name}",
      released: "Shipped in release {name}",
    },
    project_stage_column: "Project stage",
    container: {
    ...
    cycle_complete_confirm: {
      ...
      body: "{count} linked requirements have not entered any release; they will stay Scheduled after completion.",
  ...
  workspace_products: {
    ...
    requirements: {
      ...
      fields: {
        ...
        status: "Status",
        status_hint: "Driven by the approval flow",
        approval: "Approval",
        approvers: "Approvers",
      ...
      approval: {
        ...
        submit: {
          title: "Submit {count} requirements for review",
          description: "These requirements are locked once submitted, until the review completes.",
          reason: "Reason",
          reason_placeholder: "What changed, and why",
