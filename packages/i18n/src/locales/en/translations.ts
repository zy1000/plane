...
export default {
  ...
  review_tailoring: {
    ...
    detail: {
      axis_meta: "{reviews} reviews × {products} products · {cells} cells",
      created_by: "Created by {name} on {date}",
      submitted_by: "Submitted by {name} {date}",
      effective: "Effective #{count} · {date}",
      pending_changes: "{count} cells changed, not submitted",
      description_placeholder: "Add a description",
      edit_title: "Edit title",
      edit_description: "Edit description",
      more: "More actions",
      stat_selected: "Selected",
      stat_cut: "Tailored out",
      stat_missing: "Missing reasons",
      stat_missing_hint: "Fill before submitting",
      stat_missing_done: "All reasons written",
      stat_after: "Once effective",
      stat_after_hint: "{created} created · {deleted} deleted",
      stat_generated: "Reviews created",
      stat_generated_unit: "",
      only_missing: "Missing reasons only",
      only_cut: "Tailored out only",
      collapse_all: "Collapse all",
      expand_all: "Expand all",
      add_review_short: "Review",
      add_product_short: "Product",
    ...
    matrix: {
      ...
      completed_will_delete:
        "This review is completed. Unchecking it and getting approval will delete it along with its trail, comments and attachments",
      locked_disabled: "The template is disabled and cannot be newly selected",
      save: "Save selection",
      rows_count: "{count} rows",
      write_reason: "Add reason",
      reason_for: "{product} · {review}",
      reason_save_hint: "to save",
      select_row: "Select / clear the whole row",
      select_all: "Select / clear everything",
      select_column: "Select / clear the whole column",
      select_stage: "Select / clear this stage",
      remove_column: "Remove column",
      remove_row: "Remove row",
      legend_cut: "Tailored out · reason shown in the cell",
      legend_locked: "Review completed, can't be tailored out",
      legend_dirty: "Corner dot = unsaved change",
      unsaved_count: "{count} unsaved changes",
      discard: "Discard",
      empty_products_title: "No products yet",
      empty_products_description: "Products are the horizontal axis. Add the ones you want to compare and you can start selecting.",
    ...
    approval: {
      ...
      you: "you",
      note: "Rejecting sends the table back for editing. Once approved under the rule it takes effect immediately, creating {created} reviews and deleting {deleted}.",
    ...
    actions: {
      ...
      add_reviews_title: "Pick the reviews to tailor",
      add_reviews_empty: "No reviews left to add",
      add_reviews_pick_stage: "Select stage",
      add_reviews_clear_stage: "Clear stage",
      add_reviews_activity_count: "{count} activities",
      add_reviews_apply: "Add {count} reviews",
      add_products_title: "Add products",
      add_reviews_search: "Search reviews",
      add_reviews_in_matrix: "In matrix",
      add_reviews_inactive: "Disabled",
      add_reviews_summary: "{reviews} reviews selected, bringing {activities} activities · {cells} new cells per product",
      add_reviews_no_match: "No matching reviews",
      add_products_search: "Search by product name or code",
      add_products_in_matrix: "In matrix",
      add_products_summary: "{columns} new columns · {cells} cells",
      add_products_apply: "Add {count} products",
    ...
    toast: {
      ...
      reviews_added: "Reviews added",
      axis_removed: "Removed from the matrix",
      failed: "Something went wrong",
    },
    errors: {
      REVIEW_TAILORING_REASON_REQUIRED: "Some tailored-out items still need a reason",
      REVIEW_TAILORING_PARENT_REQUIRED: "A selected review activity needs its parent review selected too",
      ...
      REVIEW_TAILORING_TEMPLATE_NOT_ROOT: "Reviews are added as a block; an activity cannot be added on its own",
