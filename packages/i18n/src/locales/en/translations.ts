...
export default {
  ...
  review_tailoring: {
    ...
    list: {
      status: "Status",
      revision: "Effective count",
      selected: "Selected",
      created_by: "Created by",
      approved_at: "Effective at",
      revision_value: "#{count}",
      never_effective: "Not effective",
      selected_value: "{selected} / {total}",
      axis_value: "{reviews} reviews · {products} products",
      tailoring: "Tailoring",
      updated_at: "Updated",
    ...
    matrix: {
      ...
      readonly_hint: "Read-only in the current status. Start a revision first.",
      generated: "Review created",
      unsaved: "Unsaved changes",
      save: "Save selection",
      saved: "Saved",
      stage_selected: "{selected}/{total}",
      ...
      remove_review: "Remove this review from the matrix",
      remove_product: "Remove this product from the matrix",
    },
    items: {
    ...
    approval: {
      ...
      acted_approved: "Approved",
      acted_rejected: "Rejected",
    ...
    actions: {
      ...
      add_reviews_hint: "Reviews come in as a block — their activities join the matrix with them",
      ...
      add_reviews_apply: "Add {count}",
      remove_review_title: "Remove this review?",
      remove_product_title: "Remove this product?",
      remove_axis_content: "\"{name}\" and all of its cells leave the matrix, including the tailoring reasons already written. Rows and columns that already generated reviews cannot be removed.",
      ...
      edit_header: "Edit title and description",
    },
    activity: {
      title: "History",
