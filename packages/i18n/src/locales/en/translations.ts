...
export default {
  ...
  stage_review: {
    ...
    actions: {
      ...
      hint_completed: "已评审完成，要改请先退回上一步",
  ...
  review_tailoring: {
    ...
    matrix: {
      ...
      locked_completed: "This review is completed and cannot be tailored out",
    ...
    errors: {
      ...
      REVIEW_TAILORING_REVIEW_COMPLETED: "Completed reviews cannot be tailored out",
