  ...
  workspace_templates: {
    ...
    requirements: {
      ...
      editor: {
        ...
        basic_description: "Set the template name and description.",
        ...
        builder: {
          ...
          field_library_description: "Click or drag a field into the template.",
      ...
      modal: {
        ...
        wizard: {
          ...
          summary: {
            ...
            template_hint:
              "Template data is copied into independent fields and records when the requirement is created.",
          },
        },
      },
      import: {
        ...
        details: "Import detail data",
        details_description: "Copy existing records and remap their field identifiers.",
        summary: "{fields} custom fields · {details} records",
