...
export default {
  ...
  test_handoff_date_is_required: "QA handoff date is required",
  test_handoff_date_out_of_range: "QA handoff date must be between the start date and the end date",
  due_date: "Due date",
  estimate: "Estimate",
  ...
  requirement_fields: {
    ...
    fields: {
      ...
      actions: "Actions",
      add: "Add field",
      add_child: "Add child field",
      insert_above: "Insert field above",
      insert_below: "Insert field below",
      duplicate: "Duplicate field",
      empty: "No custom fields",
      empty_description: "Add a field to define the structure of this template.",
      untitled: "Untitled field",
      repeatable: "Repeatable",
      no_children: "No child fields",
    },
    validation: {
    ...
    builder: {
      ...
      structure_fields: "Structure fields",
    ...
    empty_description: "Pick a field from the library on the left to start building the type.",
      ...
      child_drop_hint: "Release to add as a child field",
      nested_form_not_supported: "Repeatable forms cannot be nested inside another repeatable form.",
      collapse_form: "Collapse child fields",
      expand_form: "Expand child fields",
      selection_mode: "Selection mode",
      single_select: "Single select",
      multiple_select: "Multiple select",
      selector_options: "Options",
      selector_options_description: "Drag to reorder. Renaming keeps saved values connected.",
      selector_summary: "{mode} · {count} options",
      default_option: "Option {index}",
    ...
    preview: {
      title: "Field preview",
      description: "This is how the two-level header will appear on the data page.",
    empty: "Records entered with this requirement type will show up here.",
    },
  },
  requirement_approval: {
    column: "Review",
    open_change_request: "Open the change request this requirement belongs to",
  ...
  requirement_detail: {
    ...
    history: {
      ...
      empty_description: "Once this requirement is submitted for review, every approval, rejection and resulting version lands here.",
      meta: "{versions} versions · {changes} changes",
      filter: {
        all: "All",
      ...
      show_all: "Show all",
      hidden_summary: "{changes} changes that did not become a version and {schema} schema changes are hidden",
      load_error: "Version details could not be loaded; some actions are unavailable",
      ...
      action: {
        ...
        update: "changed {count} fields",
        update_generic: "submitted a change",
        delete: "deleted this requirement",
      },
      approval: {
        pending: "Waiting for {names} · {rule}",
        pending_generic: "Waiting for review · {rule}",
        approved: "Approved by {names} · {time}",
        approved_generic: "Approved · {time}",
        rejected: "{name} rejected: “{comment}”",
        rejected_no_comment: "{name} rejected",
        cancelled: "The submitter withdrew the review",
        none: "No review required, applied on submit",
      },
      diff: {
        more: "{count} more changes",
        less: "Show less",
        full: "Full comparison",
        hide_full: "Hide full comparison",
        relative_to: "Compared with v{version}",
        added: "Added",
        removed: "Removed",
        subform_changed: "Sub-form “{name}” changed, see full comparison",
        format_only: "Formatting only, text unchanged",
        unavailable: "This change left no snapshot to compare",
      },
      actions: {
        view_snapshot: "View this version",
        hide_snapshot: "Hide this version",
        compare_previous: "Compare with v{version}",
        hide_compare: "Hide comparison",
        rollback: "Roll back to v{version}",
      },
      compare: {
        button: "Compare versions",
        button_disabled: "At least two versions are needed to compare",
        from: "Older version",
        to: "Newer version",
        option: "v{version} · {date}",
        hint: "Adjacent versions are selected by default",
        confirm: "Compare",
        title: "v{from} → v{to}",
        close: "Close",
      },
      schema: {
        group: "The field structure of requirement type {name} changed {count} times",
        single: "changed the field structure of requirement type {name}",
        scope: "Type-level change, applies to every requirement of this type without review",
        op_create: "Added",
        op_update: "Changed",
        op_delete: "Removed",
        expand: "Expand",
    ...
    test_cases: {
      ...
      unlink: "Unlink",
      unlink_confirm_title: "Unlink test case",
      unlink_confirm_description: "Once unlinked, this test case no longer verifies this requirement.",
      out_of_scope: "Some test cases are outside this requirement's projects. Link the requirement to that project first, or pick a case from a shared repository.",
      toast_linked: "Test cases linked",
      toast_unlinked: "Test case unlinked",
    ...
    subform: {
      ...
      empty: "No rows",
      add_row: "Add row",
      reorder_row: "Drag to reorder row",
      row_number: "No.",
    ...
    versions: {
      ...
      rollback_done: "Rolled back to v{version}. Submit it for review again.",
      rollback_failed: "The rollback could not be completed. Please try again.",
    },
    meta: {
      label: "Details",
  ...
  requirement_grid: {
    error_title: "Unable to load requirement data",
    toast: {
    ...
    pagination: {
      ...
      delete_many_description:
        "Are you sure you want to delete these {count} requirement types? All related data will be permanently removed. This action cannot be undone.",
    },
    filters: {
      contains: "Contains",
      equals: "Equals",
    ...
    data: {
      ...
      required_missing_prefix: "Still missing: ",
      required_separator: ", ",
      required_done: "All required fields are filled",
      priority_none: "None",
      parent_none: "Not set",
      new: "New",
      copy_badge: "Copy",
      saved: "Record saved.",
      saved_all: "{count} records saved.",
      edit_data: "Edit data",
      bulk_edit_mode: "Bulk edit mode",
      changed_count: "{count} changed",
      save_changes: "Save changes",
      undo: "Undo",
      empty: "No requirement records yet",
    no_fields: "This requirement type has no enabled fields",
      no_fields_description: "Configure at least one field before adding data.",
      ...
      expand_rich_text: "Expand to edit",
      edit_rich_text: "Edit “{field}”",
      yes: "Yes",
      no: "No",
      ...
      discard_confirm: "Discard the record currently being edited?",
      discard_all_confirm: "Discard all unsaved changes on this page?",
    conflict: "Some records or the field structure changed. Reload the latest data to continue.",
      reload_to_continue: "Reload data",
  ...
  requirement_modules: {
    ...
    delete_confirm_title: "Delete module",
    delete_confirm_content:
      "This deletes \"{name}\" and all of its sub-modules. Requirements in them are kept and return to All requirements.",
    move_to_module: "Move to module",
    move_modal_title: "Move to module",
    move_none: "All requirements (no module)",
    toast: {
      select_target: "Select a target module",
      move_success: "Moved {count} requirements",
      move_failed: "Failed to move requirements",
      create_failed: "Failed to create the module",
      rename_failed: "Failed to rename the module",
      delete_failed: "Failed to delete the module",
    },
  },
  requirement_libraries: {
    ...
    fields: {
      ...
      requirement_type_warning:
        "The requirement type cannot be changed after creation — every item in this library will share its field structure.",
      requirement_type_manage: "Manage requirement types",
      requirement_type_empty: "No matching requirement types",
      field_count_badge: "{count} fields",
      optional: "Optional",
      description: "Description",
      description_placeholder: "Scope of these items, maintenance conventions…",
      field_count: "Fields",
      item_count: "Items",
      actions: "Actions",
    },
    validation: {
      name_required: "Enter a library name.",
      requirement_type_required: "Pick a requirement type.",
    },
    empty: {
      title: "No standard libraries yet",
      description: "A library builds on a requirement type to collect a set of consistently structured items.",
    },
    list: {
      search_placeholder: "Search libraries",
      reset_view: "Reset view",
      filtered_by: "Filtered by:",
      clear_requirement_type_filter: "Clear template filter",
      requirement_type_filter_fallback: "Selected template",
      updated_at: "Updated",
      no_description: "No description",
      ...
      previous_page: "Previous page",
      next_page: "Next page",
      select_page: "Select all libraries on this page",
      select_library: "Select {name}",
      delete_selected: "Delete selected ({count})",
      ...
      empty_filtered_title: "No matching libraries",
      empty_filtered_description: "Try another search term or clear the current search.",
      error_title: "Unable to load standard libraries",
    },
    detail: {
      requirement_type_tooltip: "Every item in this library shares this template's fields. Open the template.",
      error_title: "Unable to load standard library",
    },
    items: {
      fields_readonly_prefix: "Fields come from the template ",
      fields_readonly_suffix: " and cannot be edited here.",
    },
    toast: {
  ...
  project_stage: {
    ...
    status_hint: {
      not_started: "clears actual dates",
      in_progress: "sets actual start",
      completed: "sets actual end",
    },
    table: {
      name: "Stage",
      code: "Type",
      ...
      status: "Status",
      children: "{count} sub-stages",
      review_count: "{count} reviews",
      review_count_hint: "Stages with reviews cannot be deleted or retyped",
      unassigned: "Unassigned",
      edit: "Edit",
      add_child: "Add sub-stage",
      delete: "Delete",
      expand: "Expand",
      collapse: "Collapse",
    },
    footer: {
      ratio_total: "Total weight",
      remaining: "{value}% left",
      leaf_only: "Only stages without sub-stages count",
    },
    empty: {
      title: "No stages yet",
    ...
    form: {
      create_title: "New stage",
      create_child_title: "New sub-stage",
      edit_title: "Edit stage",
      stage_type: "Stage type",
      stage_type_required: "Select a stage type",
      name_placeholder: "Stage name",
      name_hint: "Pick a stage type on the left; the name defaults to the type name and can be changed",
      type_locked_hint: "Stages imported from the dev mode keep their type",
      group_hierarchy: "Hierarchy",
      parent: "Parent stage",
      parent_root: "Root (no parent)",
      parent_locked_hint: "The parent cannot be changed after creation",
      milestone: "Milestone",
      milestone_on: "Yes",
      milestone_off: "No",
      ...
      start_date: "Planned start",
      end_date: "Planned end",
      schedule_hint: "Must fall within the parent stage: {start} ~ {end}",
      group_owner: "Owner & weight",
      owner: "Owner",
      owner_placeholder: "Select owner",
      ratio: "Weight",
      ratio_hint: "{remaining}% left to allocate",
      ratio_inherit_hint: "Leave empty to inherit the parent's {value}% (moved down to this sub-stage)",
      ratio_parent_hint: "A stage with sub-stages sums their weight, currently {value}%",
      ratio_over_limit: "Exceeds the remaining weight, at most {remaining}%",
    ...
    delete_modal: {
      ...
      bulk_title: "Delete {count} selected stages?",
      description: "This cannot be undone. Delete sub-stages before their parent.",
      confirm: "Delete",
      deleting: "Deleting",
    },
    bulk: {
      selected_count: "{count} selected",
      select_row: "Select this stage",
      select_all: "Select all",
      edit_properties: "Edit properties",
      delete: "Delete",
      panel_title: "Edit {count} stages",
      keep_unchanged: "Keep unchanged",
      reset: "Back to unchanged",
      set_none: "Set none",
      clear_date: "Clear",
      none_date: "No date",
      changed_count: "{count} changed",
      apply: "Apply to {count} stages",
      toast_success: "Updated {count} stages",
      toast_partial: "Updated {updated}, {failed} failed",
      toast_partial_detail: "\"{name}\": {error}",
      toast_error: "Bulk update failed",
    },
    toast: {
      created: "Stage created",
      updated: "Stage updated",
      deleted: "Stage deleted",
      bulk_deleted: "Deleted {count} stages, {failed} failed",
      update_error: "Update failed",
      delete_error: "Delete failed",
    },
    errors: {
      project_stage_type_locked: "Stages imported from the dev mode keep their type",
      project_stage_parent_immutable: "The parent cannot be changed after creation",
      project_stage_owner_not_member: "The owner must be a project member",
      project_stage_name_required: "Stage name is required",
      project_stage_ratio_out_of_range: "Weight must be between 0 and 100",
      project_stage_type_workspace_mismatch: "Stage type belongs to another workspace",
      project_stage_parent_project_mismatch: "Parent stage belongs to another project",
      project_stage_in_use: "This stage has reviews or tailoring cells. Move them to another stage in the tailoring table, or delete the reviews first",
      project_stage_type_in_use: "A stage with reviews cannot change its type",
    },
  },
  stage_review: {
    title: "阶段评审",
    ...
    bulk: {
      ...
      select_row: "选择这条评审",
      select_all: "选择全部",
      locked_hint: "已评审的评审不能修改",
      edit_properties: "修改属性",
      panel_title: "修改 {count} 条评审的属性",
      keep_unchanged: "保持不变",
      set_none: "设为无",
      clear_date: "清空",
      none_date: "清空日期",
      reset: "改回保持不变",
      changed_count: "已改 {count} 项",
      cancel: "取消",
      apply: "应用到 {count} 条",
      toast_success: "已更新 {count} 条评审",
      toast_partial: "已更新 {updated} 条，{failed} 条未能修改",
      toast_partial_detail: "「{title}」：{error}",
      toast_skipped: "{count} 条已评审，已跳过",
      toast_error: "批量修改失败",
    },
    rail: {
      title: "研发阶段",
      empty: "这个项目还没有生效的裁剪表，所以还没有评审。",
    },
    status: {
      not_started: "未评审",
      in_review: "评审中",
    ...
    list: {
      search_placeholder: "搜索评审标题",
      summary_meta: "{reviews} 条评审 · {products} 个产品",
      summary_meta_projects: "{reviews} 条评审 · {projects} 个项目",
      summary_meta_stages: "{reviews} 条评审 · {stages} 个阶段",
      current: "当前",
      current_stage: "当前阶段",
      summary_plan: "计划 {range}",
      clear_filters: "清除全部",
      me: "我",
      unassigned: "未指定",
      no_result: "暂无结论",
      ...
      all_reviews: "全部评审",
      expand_sidebar: "展开分组侧栏",
      collapse_sidebar: "收起分组侧栏",
    },
    display: {
      title: "显示",
      properties: "显示属性",
      order_by: "排序方式",
      show_activities: "显示评审活动",
    ...
    product_empty: {
      no_projects_title: "这个产品还没有关联项目",
      no_projects_description: "阶段评审由项目里的评审裁剪表勾选生成。先把产品关联到项目，再在项目的「评审裁剪」里为它勾选要做的评审。",
      no_reviews_title: "这个产品还没有阶段评审",
      no_reviews_description: "评审由项目里的评审裁剪表勾选生成。在关联项目的「评审裁剪」里为这个产品勾选要做的评审，签批生效后就会出现在这里。",
      link_projects: "关联项目",
      go_tailoring: "去评审裁剪",
    },
    empty: {
      title: "这个阶段还没有评审",
      description: "裁剪表签批生效后，勾中的格子会变成这里的一条条评审。",
    },
    fields: {
      product: "产品",
      stage: "评审阶段",
      ...
      plan_date: "计划日期",
      description: "描述",
      work_instruction: "工作指引",
      result: "评审结果",
      conditional_reason: "结论说明",
      akf_code: "AKF 编号",
      production_quantity: "生产数量",
      product_config: "产品配置",
      baseline_archive_code: "基线归档号",
      components: "组件",
    ...
    detail: {
      ...
      properties: "属性",
      conclusion: "结论",
      result_pending: "提交审核时填写",
      source: "来源",
      source_manual: "手工新建，不进裁剪表",
      source_tailoring: "由裁剪表生成",
      role_leader: "主导 {role}",
      role_auditor: "审核 {role}",
      created_at: "创建于 {date}",
      add_description: "Add description",
      add_work_instruction: "Add work instructions",
      saving: "Saving…",
      saved: "Saved",
      save_failed_retry: "Save failed, click to retry",
      ...
      no_timeline: "还没有活动",
      no_status: "还没有状态记录",
      components_placeholder: "基表硬件、基表软件…",
      description_placeholder: "写清楚这条评审要核对什么、对照哪份文件…",
      work_instruction_placeholder: "Click to add work instructions",
      finished_goods: "成品",
      component_versions: "组件版本",
      component_version_placeholder: "主板：板内 V2.2，板边 V2.4",
      upload: "上传附件",
      no_attachments: "还没有附件",
      download: "下载",
      uploaded_by: "{name} 上传于 {date}",
      delete_attachment_confirm: "确定删除附件「{name}」吗？删除后无法恢复。",
      preview_unsupported: "暂不支持预览此文件类型",
      preview_failed: "预览失败",
      comment_placeholder: "写下你的评审意见…",
      comment_submit: "发表评论",
      no_comments: "还没有评论",
      no_activity: "还没有修改记录",
      pick_member: "选择成员",
      no_candidates: "没有匹配的成员",
      role_source_workspace: "产品下没有「{role}」，这里列的是工作区里担任该角色的人",
      ...
      unassigned: "未指定",
      set_date: "设置日期",
      stage_locked_tailoring: "裁剪表",
      stage_locked_tailoring_hint: "阶段由裁剪表决定。要挪，请到裁剪表发起修订",
      stage_locked_summary: "汇总评审",
      stage_locked_summary_hint: "只有评审活动能移动阶段，汇总评审不能",
      edit: "编辑",
      drop_hint: "把文件拖到这里，或点右上角上传",
      comment_send: "发送",
      role_chip_leader: "负责人",
      role_chip_auditor: "审核人",
      step_waiting_start: "等待开始",
      step_driven_by: "由 {name} 推进",
      step_waiting_leader: "等待负责人推进",
      step_waiting_auditor: "等待 {name} 审核",
      step_waiting_audit: "等待审核",
      step_rejected: "评审不通过，待整改重提",
    },
    actions: {
      start: "开始评审",
      ...
      approve: "审核通过",
      rollback_plain: "退回",
      blocked_no_leader: "还没有负责人，先指定负责人才能推进",
      blocked_no_auditor: "还没有审核人，先指定审核人才能继续",
      blocked_not_leader: "这一步由负责人 {name} 推进",
      blocked_not_auditor: "这一步由审核人 {name} 审核",
      blocked_rollback_not_leader: "只有负责人 {name} 能退回",
      blocked_rollback_not_auditor: "只有审核人 {name} 能退回",
      close: "关闭",
      cancel: "取消",
      delete: "删除",
    },
    submit: {
      title: "提交审核",
      description: "结论决定下一步：不通过留在评审中，其余（通过 / 免审 / 条件通过）进入审核。",
      effect_approval: "提交后进入审核中，由 {auditor} 完成审核。",
      effect_approval_no_auditor: "提交后进入审核中，等待审核人完成审核。",
      effect_rejected: "评审不通过：状态留在「评审中」，整改后再次提交。",
      result: "评审结果",
      reason: "结论说明",
      reason_optional: "（选填）",
      reason_placeholder: "补充说明本次结论的依据",
      reason_placeholder_passed: "可补充通过的依据或遗留事项",
      reason_placeholder_conditional: "写明放行条件与关闭时间",
      reason_placeholder_rejected: "写明不通过的问题与整改要求",
      reason_placeholder_waived: "写明免审的理由与依据",
      confirm_rejected: "记录不通过",
      production_mode: "生产方式",
      shipment_assessment: "出货评估",
    },
    rollback: {
      title: "退回上一步",
      description: "退回到「{status}」，理由会记进变更轨迹。",
      description_plain: "退回上一步，理由会记进变更轨迹。",
      reason: "退回理由",
    ...
    activity: {
      ...
      rejected: "评审不通过",
      waive_done: "免审完成",
      edits_count: "修改了 {count} 项",
      content_updated: "更新了内容",
      created_manual: "手工新建了这条评审",
      system: "系统",
      change_from: "把{field}从",
      change_to: "改为",
      set_to: "把{field}设为",
      cleared: "清空了{field}",
      was: "原为",
      updated_plain: "更新了{field}",
      attachment_created: "上传了附件",
      attachment_deleted: "删除了附件",
    },
    errors: {
      STAGE_REVIEW_RESULT_REQUIRED: "提交审核前要先选评审结果",
      STAGE_REVIEW_CONDITIONAL_REASON_REQUIRED: "条件通过 / 不通过必须填写结论说明",
      STAGE_REVIEW_PRODUCTION_MODE_REQUIRED: "O 阶段评审必须选择生产方式",
      STAGE_REVIEW_SHIPMENT_ASSESSMENT_REQUIRED: "O 阶段评审必须选择出货评估",
      STAGE_REVIEW_O_STAGE_FIELD_NOT_ALLOWED: "生产方式 / 出货评估只属于 O 阶段的评审类型",
      STAGE_REVIEW_LOCKED: "已评审的评审已定稿，不能再修改或退回",
      STAGE_REVIEW_ONLY_ACTIVITY_CAN_MOVE: "只有评审活动能移动阶段",
      STAGE_REVIEW_STAGE_BY_TAILORING: "阶段由裁剪表决定，请到裁剪表发起修订",
      STAGE_REVIEW_STAGE_NOT_IN_PROJECT: "The target stage does not belong to this project",
      STAGE_REVIEW_ALREADY_COMPLETED: "已评审的评审不能再往前推进",
      STAGE_REVIEW_NO_PREVIOUS_STATUS: "未评审的评审没有上一步可退",
      STAGE_REVIEW_ROLLBACK_REASON_REQUIRED: "退回必须填写理由",
      STAGE_REVIEW_LEADER_REQUIRED: "还没有负责人，先指定负责人才能推进",
      STAGE_REVIEW_AUDITOR_REQUIRED: "还没有审核人，先指定审核人才能继续",
      STAGE_REVIEW_NOT_LEADER: "只有负责人能推进或退回这一步",
      STAGE_REVIEW_NOT_AUDITOR: "只有审核人能审核或退回这一步",
      STAGE_REVIEW_FROM_TAILORING_UNDELETABLE: "裁剪生成的评审要回裁剪表取消勾选后才会删除",
      STAGE_REVIEW_PARENT_INVALID: "所属评审不存在或不属于同一个产品",
  ...
  review_tailoring: {
    ...
    empty: {
      title: "No tailoring yet",
      description: "A tailoring is a review × product checklist. Checked reviews become stage reviews once approved; unchecked ones need a reason.",
      filtered: "No tailorings match these filters",
      no_permission: "You don't have permission to manage review tailoring.",
    },
    list: {
      status: "Status",
      selected: "Selected",
      created_by: "Created by",
      never_effective: "Not effective",
      tailoring: "Tailoring",
      updated_at: "Updated",
      axis_meta: "{reviews} reviews × {products} products",
      axis_empty: "No reviews or products yet",
      sub_pending: "Round {round} · {approved} / {total} approved · {rule}",
      sub_approved: "Effective #{count} · {date} · {generated} reviews generated",
      sub_revising: "Last effective {date}",
      sub_revising_changes: "{count} unsubmitted changes",
      today_at: "Today {time}",
      copy_link: "Copy link",
      link_copied: "Link copied",
    },
    ...
    steps: {
      ...
      pick_reviews: "Pick reviews",
      pick_reviews_hint: "Rows · whole reviews at a time",
      add_products: "Add products",
      add_products_hint: "Columns · this project's products",
      select: "Select & approve",
      select_hint: "Give a reason for skipped cells",
    },
    kind: {
      process: "Process review tailoring",
      o_stage: "O-stage review tailoring",
    },
    form: {
      create_title: "New tailoring",
      title_label: "Title",
      title_placeholder: "e.g. Stage I review tailoring",
      title_required: "Title is required",
      kind_label: "Tailoring type",
      kind_required: "Choose a tailoring type",
      kind_hint_process: "Only process reviews and activities can be added, no O-stage ones",
      kind_hint_o_stage: "Only O-stage reviews and O-stage activities can be added",
      kind_locked: "The tailoring type cannot be changed after creation",
      description_label: "Description",
      optional: "Optional",
      submit: "Create",
      description_placeholder: "Background and notes for this tailoring (optional)",
    ...
    detail: {
      ...
      filtered_empty_stage: "No rows in this stage",
      filter_all: "All",
      filter_cut: "Cut",
      filter_missing: "Need reasons",
      add_axes: "Add reviews / products",
      description_save_hint: "or click outside to save",
      description_saved: "Saved",
      description_expand: "Show all",
      description_collapse: "Show less",
    },
    matrix: {
      ...
      reason_save: "Save reason",
      completed_will_delete:
        "This review is completed. Cutting it and getting approval will delete it along with its trail, comments and attachments",
      locked_disabled: "The template is disabled and cannot be switched to keep",
      save: "Save tailoring",
      rows_count: "{count} rows",
      product_range: "Products {from}–{to} of {total}",
      prev_column: "Previous column",
      next_column: "Next column",
      write_reason: "Add a reason",
      reason_for: "{product} · {review}",
      reason_save_hint: "to save",
      keep: "Keep",
      cut: "Cut",
      remove_column: "Remove column",
      remove_row: "Remove",
      unsaved_count: "{count} unsaved changes",
      discard: "Discard",
      empty_products_title: "No products yet",
      empty_products_description: "Products are the horizontal axis. Add the ones you want to compare and you can start keeping or cutting each cell.",
      empty_reviews_title: "No reviews picked yet",
      empty_reviews_description: "Reviews are the vertical axis. Add only the ones this project actually involves — what you leave out takes no row and needs no tailoring reason.",
      row_cut_count: "{count} cut",
      summary: "{kept} kept · {cut} cut",
      summary_missing: "{count} need reasons",
      selected_count: "{count} cells selected",
      keep_all: "Keep all",
      cut_all: "Cut all",
      clear_selection: "Clear selection",
    ...
    items: {
      ...
      bulk_reason: "Fill reason",
      bulk_reason_title: "Fill tailoring reason",
      bulk_reason_apply: "Apply to {count} items",
      bulk_reason_scope: "Writes to {count} tailored items",
      bulk_reason_overwrite: "{count} existing reasons will be replaced",
      bulk_reason_skip: "Kept items need no reason and are skipped",
      selected_count: "{count} selected",
      select_all_count: "Select all {count}",
      select_all_rows: "Select all",
      select_row: "Select this row",
      empty: "No matching details",
    },
    approval: {
      submit: "Submit for approval",
      submit_title: "Submit for approval",
      approvers: "Approvers",
      approvers_help: "Approvers must be members of this project",
      approvers_required: "Select at least one approver",
      rule: "Approval rule",
      any: "Any one approves",
      all: "Everyone approves",
      rule_any: "Any one approves",
      rule_all: "Everyone approves",
      rule_n_of_m: "{count} approvals",
      approve: "Approve",
      reject: "Reject",
      withdraw: "Withdraw",
      comment_placeholder: "Approval note (optional)",
      status_waiting: "Waiting",
      status_approved: "Approved",
      status_rejected: "Rejected",
      summary_selected: "Kept",
      summary_after: "Creates on approval",
      summary_after_unit: "reviews",
      summary_missing: "Missing reasons",
      summary_fix: "Fill them →",
      completed_delete_warning:
        "{count} completed reviews will be deleted once approved, along with their trail, comments and attachments. This cannot be undone",
      missing_block: "{count} cells still need a tailoring reason",
      add_approver: "Add approvers…",
      remove_approver: "Remove approver",
      n_of_m_short: "Set number",
      progress: "{approved} / {total} approved",
      inbox_button: "My approvals",
      inbox_title: "Tailoring approvals",
      tab_pending: "Waiting for me",
      tab_done: "Signed by me",
      empty_pending: "Nothing is waiting for you",
      empty_done: "You haven't signed any yet",
      select_hint: "Pick a tailoring on the left",
      inbox_item_meta: "{name} · round {round}",
      auto_next: "Moves to the next one after you sign",
      sign: "Sign",
      view: "Approval details",
      pending_for_you: "Needs your sign-off",
      submitted_meta: "Submitted by {name} {date} · round {round}",
      open_tailoring: "Open tailoring",
      impact_title: "Takes effect once approved",
      impact_kept: "Kept",
      impact_kept_hint: "{products} products · {rows} rows",
      impact_cut: "Cut",
      impact_cut_done: "All reasons written",
      impact_cut_missing: "{count} cells need reasons",
      impact_after: "Reviews after approval",
      impact_after_hint: "{created} created · {deleted} deleted",
      impact_moved: "Moved",
      impact_moved_hint: "Reviews switch stage, IDs unchanged",
      impact_moved_skip: "{count} already reviewed, will be skipped",
      changes_title: "Changes",
      changes_all: "All",
      change_add: "Add",
      change_cancel: "Remove",
      change_move: "Move",
      change_will_skip: "Reviewed, will be skipped",
      progress_title: "Progress",
      you_short: "You",
      waiting_you: "Waiting for your decision",
      my_decision: "Your decision",
      approve_hint: "Takes effect once the rule is met",
      reject_hint: "Sends it back to the submitter",
      confirm_approve: "Approve",
      confirm_reject: "Reject",
      choose_first: "Choose a decision first",
      acted_approved: "You approved · {date}",
      acted_rejected: "You rejected · {date}",
      not_approver: "You're not an approver this round; view only",
      ended: "This round has ended",
    },
    actions: {
      revise: "Start revision",
      cancel_revision: "Cancel revision",
      cancel_revision_title: "Cancel revision",
      cancel_revision_content: "Selections and reasons go back to the last effective state. Changes made during this revision are discarded.",
      add_products: "Add products",
      add_reviews: "Add reviews",
      add_reviews_empty_process: "No stage of this project has process reviews or activities left to add",
      add_reviews_empty_o_stage: "No stage of this project has O-stage reviews or activities left to add",
      add_reviews_activity_count: "{count} activities",
      add_reviews_search: "Search reviews or activities",
      add_reviews_in_matrix: "In table",
      add_reviews_inactive: "Disabled",
      add_reviews_no_match: "No matching reviews",
      add_products_search: "Search by product name or code",
      add_products_in_matrix: "In table",
      add_products_no_match: "No matching products",
      remove_row_title: "Remove the \"{name}\" row?",
      remove_column_title: "Remove the \"{name}\" column?",
      remove_axis_detail: "Its {cells} cells leave the matrix, along with {reasons} tailoring reasons already written.",
      remove_row_multi_stage: "This review has a row under {stages} stages; all of them are removed.",
      remove_axis_in_use: "\"{name}\" already generated reviews and can't be removed. Revise and clear its selections instead.",
      cancel_revision_confirm: "Discard revision",
      add_products_empty: "No products left to add",
      delete: "Delete tailoring",
      delete_title: "Delete tailoring",
      delete_content: "This cannot be undone. An effective tailoring cannot be deleted.",
      add_axes_title: "Add reviews and products",
      add_axes_reviews: "Reviews",
      add_axes_products: "Products",
      add_axes_picked: "{count} picked",
      add_axes_stage_count: "{count} available",
      add_axes_stage_in_matrix: "In table",
      add_axes_stage_none: "Nothing to add",
      add_axes_stage_filter: "Stage",
      add_axes_multi_stage: "{stages} stages",
      add_axes_stage_all: "All",
      add_axes_col_stage: "Stage",
      add_axes_col_review: "Review / activity",
      add_axes_col_product: "Product",
      add_axes_select_all: "Select all",
      add_axes_clear_all: "Clear all",
      add_axes_summary: "{reviews} reviews · {activities} activities → {rows} rows · {products} products → {cells} new cells",
      add_axes_summary_reviews: "{reviews} reviews · {activities} activities → {rows} rows → {cells} new cells",
      add_axes_summary_products: "{products} products → {cells} new cells",
      add_axes_apply: "Add {rows} rows · {products} products",
      add_axes_apply_reviews: "Add {rows} rows",
      add_axes_apply_products: "Add {products} products",
    },
    activity: {
      title: "History",
      empty_title: "No history yet",
      empty_description: "Creating, keeping and cutting, approving and taking effect are all recorded here.",
      system: "System",
      filter_all: "All",
      filter_status: "Status",
      filter_edits: "Edits",
      created: "created the tailoring",
      title_changed: "changed the title from {old} to {new}",
      description_changed: "updated the description",
      products_added: "added {count} products",
      reviews_added: "added {count} reviews",
      products_removed: "removed 1 product",
      reviews_removed: "removed 1 review",
      items_synced: "synced the matrix: {added} cells added, {removed} removed",
      and_more: "and {count} more",
      cell_keep: "kept",
      cell_cut: "cut",
      cell_reason: "updated the reason for",
      cells_changed: "changed {count} cells",
      count_keep: "{count} kept",
      count_cut: "{count} cut",
      count_reason: "{count} reasons",
      count_move: "{count} moved",
      cell_move: "moved",
      action_move: "Move",
      action_keep: "Keep",
      action_cut: "Cut",
      action_reason: "Reason",
      reason_cleared: "cleared the reason",
      submitted: "submitted approval round {round}",
      approved_partial: "approved ({value})",
      applied: "approved, the tailoring took effect",
      applied_counts: "{created} reviews created · {deleted} removed",
      applied_moved: " · {count} moved",
      applied_skipped: "Skipped {count} moves: {items} (already reviewed at approval)",
      rejected: "rejected the approval",
      withdrawn: "withdrew the approval",
      revising: "started a revision",
      revision_cancelled: "cancelled the revision",
      comment: "commented",
      fallback: "updated the tailoring",
    },
    comments: {
      title: "Comments",
      ...
      delete_failed: "Failed to delete the comment",
    },
    toast: {
      created: "Tailoring created",
      updated: "Updated",
      deleted: "Tailoring deleted",
      cells_saved: "Tailoring saved",
      submitted: "Submitted for approval",
      approved: "Approved. The tailoring is now effective",
      rejected: "Rejected",
      withdrawn: "Approval withdrawn",
      revising: "Revision started",
      revision_cancelled: "Revision cancelled",
      axis_removed: "Removed from the matrix",
      failed: "Something went wrong",
      axes_added: "Added to the matrix",
      approval_recorded: "Approved. Waiting for other approvers",
      approved_with_skipped: "Tailoring is effective. {count} moves were skipped because they were already reviewed",
    },
    move_stage: {
      menu: "Move to stage…",
      bulk: "Move to stage",
      title: "Move to stage",
      subtitle_many: "{count} review activities",
      current: "Current",
      parent: "Parent review \"{title}\"",
      col_code: "Code",
      col_stage: "Stage",
      col_type: "Stage type",
      tag_current: "Current stage",
      tag_conflict: "Already has it",
      hint: "After moving, the activity leaves its parent review and sits directly under the target stage. Moving it back will not re-attach it. Keep / cut and reasons stay as they are.",
      excluded: "{count} other cells are summary reviews or already reviewed and won't move",
      confirm: "Move {count} cells",
      confirm_to: "Move to {stage} · {count} cells",
      nothing_movable: "None of the selected cells can move: summary reviews and reviewed activities stay put",
      blocked_completed: "Reviewed, can't move",
      moved_from: "From {stage}",
      moved_from_tooltip: "Review activity moved here from \"{stage}\"",
      moved_to_prefix: "Moved to",
      stat_moved: "Moved",
      skipped_title: "Revision is effective; {count} moves were skipped",
      skipped_item: "Still in {stage} (planned: {target}), already reviewed at approval",
      skipped_dismiss: "Got it",
    },
    errors: {
      REVIEW_TAILORING_REASON_REQUIRED: "Some tailored-out items still need a reason",
      REVIEW_TAILORING_TEMPLATE_DISABLED: "Some selections come from a disabled template",
      REVIEW_TAILORING_APPROVER_INVALID: "Approvers must be members of this project",
      REVIEW_TAILORING_PRODUCT_NOT_LINKED: "Some products are not linked to this project",
      REVIEW_TAILORING_TEMPLATE_INVALID: "Some reviews are not in this workspace's template library, or are disabled",
      REVIEW_TAILORING_AXIS_IN_USE: "This row/column already generated reviews. Uncheck them in a revision instead.",
      REVIEW_TAILORING_AXIS_NOT_FOUND: "This row/column is not on the matrix",
      REVIEW_TAILORING_NO_CHANGES: "Nothing changed since the tailoring took effect",
      REVIEW_TAILORING_EMPTY: "This tailoring has nothing to submit",
      REVIEW_TAILORING_NOT_EDITABLE: "Read-only in the current status",
      REVIEW_TAILORING_NOT_PENDING: "This tailoring is not waiting for approval",
      REVIEW_TAILORING_NOT_APPROVED: "Only an effective tailoring can be revised",
      REVIEW_TAILORING_NOT_REVISING: "This tailoring is not being revised",
      REVIEW_TAILORING_NOT_APPROVER: "You are not an approver of this round",
      REVIEW_TAILORING_NOT_SUBMITTER: "Only the submitter can withdraw this approval",
      REVIEW_TAILORING_ALREADY_ACTED: "You have already acted on this round",
      REVIEW_TAILORING_EFFECTIVE_UNDELETABLE: "An effective tailoring cannot be deleted",
      REVIEW_TAILORING_PENDING_UNDELETABLE: "Withdraw the approval before deleting",
      REVIEW_TAILORING_NO_SNAPSHOT: "No effective snapshot to restore",
      REVIEW_TAILORING_ONLY_ACTIVITY_CAN_MOVE: "Only review activities can move to another stage",
      REVIEW_TAILORING_STAGE_NOT_IN_PROJECT: "The target stage does not belong to this project",
      REVIEW_TAILORING_MOVE_COMPLETED: "Reviewed activities cannot move to another stage",
  ...
  workspace_templates: {
    ...
    dev_modes: {
      title: "Dev modes",
      field: {
        enabled_features: "Components",
      },
      create: "New dev mode",
      search_placeholder: "Search dev modes",
      error_title: "Failed to load dev modes",
      features: {
        cycle_view: "Cycles",
        module_view: "Modules",
        release_view: "Releases",
        issue_views_view: "Views",
        page_view: "Pages",
        intake_view: "Intake",
        is_time_tracking_enabled: "Time tracking",
        is_issue_type_enabled: "Work item types",
        review_view: "Reviews",
      },
      empty: {
        title: "No dev modes yet",
        description:
          "A dev mode decides which components a project can use, which stages it has, and which reviews each stage enables.",
        no_match_title: "No matching dev modes",
        no_match_description: "Try another keyword, or clear the search box.",
      },
      card: {
        preset: "Preset",
        custom: "Custom",
        no_description: "No description",
        stages: "stages",
        templates: "review nodes",
        projects: "projects using it",
        edit: "Edit",
        delete: "Delete",
        delete_preset_blocked: "Preset dev modes cannot be deleted",
        delete_in_use_blocked: "Used by projects, cannot be deleted",
      },
      form: {
        create_title: "New dev mode",
        edit_title: "Edit dev mode",
        icon_label: "Icon",
        name_label: "Name",
        description_label: "Description",
        description_placeholder: "What kind of projects this way of working suits",
        features_label: "Components",
        features_hint: "Components you turn off are hidden in projects right away. No data is deleted.",
        preset_locked: "Preset",
        create: "Create",
        save: "Save",
      },
      detail: {
        edit_mode: "Edit dev mode",
        preset_hint: "Preset dev modes cannot be renamed or deleted. Components and stages are still editable.",
      ...
      table: {
        ...
        bulk_create: "Add several",
        create: "New stage",
        col_index: "#",
        col_name: "Stage name",
        col_code: "Code",
        col_stage_type: "Stage type",
        col_ratio: "Workload",
        col_days: "Duration",
        ...
        drag_hint_full: "Drag the handle to reorder. Saves on drop.",
        ratio_total: "Workload total",
        ratio_remaining: "{value}% left",
        empty_title: "This dev mode has no stages",
        empty_description:
          "Pick stage types from the stage type library. Tailoring tables in projects group by these stages.",
      },
      stage_form: {
        create_title: "New stage",
        edit_title: "Edit stage",
        stage_type_label: "Stage type",
        type_locked_hint: "The stage type is fixed once created. Delete the stage and create a new one to change it.",
        name_label: "Stage name",
        name_hint: "Defaults to the type name. Must be unique within the dev mode.",
        ratio_label: "Workload share",
        days_label: "Standard duration",
        days_unit: "d",
        create: "Create",
        save: "Save",
      },
      bulk_create: {
        title: "Add several stages",
        hint: "Pick stage types. Each one becomes a stage named after the type, with every review node under it checked. Types that already have a stage of the same name are skipped.",
        already_added: "Added",
        node_count: "{count} nodes",
        confirm: "Add {count} stages",
      },
      panel: {
      ...
      delete_modal: {
        title: "Delete dev mode “{name}”?",
        description:
          "This cannot be undone. Its stages and review selections go with it. Dev modes used by projects cannot be deleted.",
        confirm: "Delete",
        deleting: "Deleting",
      },
      delete_stage_modal: {
        title: "Delete stage “{name}”?",
        bulk_title: "Delete the {count} selected stages?",
        description:
          "This cannot be undone. The review nodes checked under it are cleared. Stages used by a tailoring table or a review cannot be deleted.",
        confirm: "Delete",
        deleting: "Deleting",
      },
      toast: {
        created: "Dev mode created",
        updated: "Dev mode updated",
        deleted: "Dev mode deleted",
        delete_failed: "Cannot delete “{name}”",
        features_updated: "Components saved",
        stage_created: "Stage created",
        stage_updated: "Stage updated",
        stages_created: "{created} stages added, {skipped} skipped",
        stage_deleted: "Stage deleted",
        stage_delete_failed: "Cannot delete stage",
        reorder_failed: "Could not save the new order",
        templates_saved: "Review selection saved",
      },
      errors: {
        generic: "Something went wrong. Try again.",
        name_required: "Enter a name",
        stage_type_required: "Pick a stage type",
        bulk_nothing_selected: "Pick at least one stage type",
        templates_load_failed: "Failed to load review nodes",
        ratio_over_limit: "Existing stages take {allocated}%. You can add at most {remaining}%.",
        dev_mode_in_use: "Projects are using this dev mode. Move them to another one first.",
        dev_mode_in_use_by_inactive_projects: "Deleted or template projects still reference this dev mode. Remove them first.",
        dev_mode_name_required: "Enter a name",
        dev_mode_name_already_exists: "That name is taken",
        dev_mode_system_name_readonly: "Preset dev modes cannot be renamed",
        dev_mode_system_protected: "Preset dev modes cannot be deleted",
        dev_mode_features_invalid: "The components payload is malformed",
        dev_mode_icon_props_invalid: "The icon payload is malformed",
        dev_mode_stage_name_required: "Enter a stage name",
        dev_mode_stage_name_already_exists: "This dev mode already has a stage with that name",
        dev_mode_stage_type_workspace_mismatch: "That stage type belongs to another workspace",
        dev_mode_stage_type_immutable: "The stage type cannot be changed. Delete and recreate the stage.",
        dev_mode_stage_ratio_out_of_range: "Workload share must be between 0 and 100",
        dev_mode_stage_template_mismatch: "Some checked review nodes do not belong to this stage type",
      },
    },
    test_cases: {
    ...
    requirement_types: {
      ...
      create: "New type",
      create_and_edit: "Create and configure",
      create_description: "Name the type, then continue configuring its custom fields.",
      switch_requirement_type: "Switch requirement type",
      empty: {
        title: "No requirement types yet",
        description: "Create a reusable structure for collecting and managing requirement data.",
      },
      list: {
        search_placeholder: "Search requirement types",
        reset_view: "Clear search",
        updated_at: "Updated",
        no_description: "No description",
        total: "{count} requirement types",
        select_page: "Select all requirement types on this page",
        select_requirement_type: "Select {name}",
        delete_requirement_type: "Delete {name}",
        delete_selected: "Delete selected ({count})",
        delete_one_title: "Delete requirement type?",
        delete_many_title: "Delete requirement types?",
        delete_one_description_prefix: "Are you sure you want to delete ",
        delete_one_description_suffix: "? All related data will be permanently removed. This action cannot be undone.",
        delete_many_description:
          "Delete these {count} requirement types? All related data will be permanently removed. This action cannot be undone.",
        delete_success: "Deleted {count} requirement types.",
        empty_filtered_title: "No matching requirement types",
        empty_filtered_description: "Try another search term or clear the current search.",
        error_title: "Unable to load requirement types",
        field_count: "Fields",
        used_by: "Used by",
        used_by_count: "{count} libraries",
        not_used: "Not used",
        delete_blocked: "This requirement type is used by {count} libraries. Remove or repoint them first.",
      },
      error: {
        title: "Unable to load this requirement type",
      },
      toast: {
        created: "Requirement type created.",
        deleted: "Requirement type deleted.",
        saved: "Requirement type saved.",
        failed: "The operation could not be completed.",
      },
      validation: {
        name_required: "Enter a type name.",
      },
      fields: {
        name: "Type name",
        name_placeholder: "e.g. Product requirement",
        owner: "Owner",
        active: "Available for use",
        active_description: "When enabled, this type can be selected while entering requirement data.",
        description_placeholder: "Explain when and how to use this type.",
        description: "Description",
      },
      editor: {
        title: "Configure requirement type",
        discard_confirm: "Discard your unsaved changes?",
        conflict_description: "Someone just updated this requirement type. The latest version has been loaded.",
        settings: "Type settings",
        settings_description: "Name, description and type overview.",
        overview: "Type overview",
        unsaved: "Unsaved",
        data_loss_confirm: "This structure change will remove values from {count} existing records. Save it anyway?",
        conflict_title: "A newer version is available",
        owner: "Owner",
        created_at: "Created",
        updated_at: "Last updated",
        field_summary: "{top} top-level / {columns} columns",
        used_by_count: "{count} libraries in use",
        used_by_hint: "Changing fields affects data already entered in these libraries.",
      },
    },
  },
  project_requirements: {
    ...
    hidden_project: "Project you cannot access",
    clear_filters: "Clear filters",
    filtered_empty: {
      title: "No requirement matches these filters",
      description: "Try another product, status or type, or clear the search term.",
    },
    columns: "Columns",
    all_types: "All types",
    title: "Requirements",
    readonly_hint: "Requirement content is maintained in the product. Submit a change request to modify it.",
    link: "Link requirements",
    unlink: "Unlink",
    ...
    unlink_confirm: {
      ...
      description:
        "Unlinks {count} requirement(s) from this project. They stay in their product with their status unchanged and are not deleted; their cycle, release and work item links in this project will be cleared.",
    },
    container: {
      title: "Linked requirements",
      link_button: "Link requirements",
      unlink: "Unlink",
      empty: "No linked requirements",
      ...
      empty_description: "Link requirements to define the scope of this sprint, and follow their progress here until the sprint ends.",
    },
    release_linkable_empty: "No requirements available to link",
    release_publish_confirm: {
      title: "Publish this release?",
      body: "{count} linked requirements are under change review. Publishing is not blocked, but be aware:",
      confirm: "Publish anyway",
      cancel: "Cancel",
    },
    toast: {
      linked: "Linked {count} requirement(s)",
      unlinked: "Unlinked",
  ...
  project_overview: {
    ...
    hero: {
      ...
      distribution: "Work items by state",
      distribution_meta: "{total} items · excluding cancelled",
      recent_completed: "Completed, last 6 months",
      month_label: "{month}",
      rules_aria: "View project health rules",
      rules_title: "Rules",
      rules_description: "Combines completion rate and overdue ratio; the worst level wins.",
      rules_completion: "Completion = completed ÷ (total − cancelled)",
      rules_overdue: "Overdue ratio = overdue open items ÷ open items",
      levels: {
        healthy: { label: "Healthy", description: "On track, risk under control", rule: "Overdue below 10% and completion at least 50%" },
        watch: { label: "Watch", description: "Some overdue items or slow progress", rule: "Overdue at least 10% or completion below 50%" },
        risk: { label: "At risk", description: "Many overdue items or progress lagging", rule: "Overdue at least 25%, or open items with completion below 20%" },
      },
    },
    states: { backlog: "Backlog", unstarted: "Unstarted", started: "Started", completed: "Completed", cancelled: "Cancelled" },
    risks: {
      overdue: "Overdue items",
      due_soon: "Due in 7 days",
      pending_defects: "Open defects",
      view: "View",
      go_defects: "Go to defects",
    },
    facts: {
      members: "Members",
      hours: "Logged hours",
    ...
    products: {
      ...
      view_all: "View all",
      link: "Link products",
      columns: { product: "Product", stage: "Stage", requirements: "Reqs", status: "Requirement status", completion: "Done" },
      code: "Code",
      identifier: "ID",
      empty_title: "No products linked yet",
      empty_description: "Requirements come from products. Link a product first to reference its requirements on the Requirements page.",
      error: "Unable to load linked products",
      no_permission: "You do not have permission to view linked products",
      formula: "Completion = released ÷ (total − closed)",
    },
    ongoing: {
      title: "In progress",
      cycle: "Current cycle",
      ...
      no_date: "No date",
      cases: "{count} cases",
      case_results: "Passed {success} · Failed {fail} · Not run {pending}",
      empty_cycle: "No cycle in progress",
      empty_release: "No release in progress",
      empty_test_plan: "No test plan in progress",
    },
    workload: {
      title: "Team workload",
      subtitle: "by open work items",
      all_members: "All {count} members",
      in_progress: "Open",
      overdue: "Overdue",
      others: "{members} others · {items} open items",
      empty: "No member data",
    },
    defects: {
      title: "Defects",
      board: "Defect board",
      pending: "Open defects",
      month_created: "New this month",
      month_resolved: "Resolved this month",
      total: "Total",
      resolved: "Resolved",
      by_priority: "Open · by priority",
      total_count: "{count} total",
      resolve_rate: "Resolution rate",
      priorities: { urgent: "Urgent", high: "High", medium: "Medium", low: "Low", none: "None" },
    },
    description: { title: "Description", expand: "Show more", empty: "No description yet", fullscreen: "Fullscreen" },
    announcements: {
      title: "Announcements",
      ...
      delete_confirm_description: "This announcement cannot be recovered after deletion. Continue?",
      cancel: "Cancel",
      load_failed_title: "Failed to load",
      load_failed_message: "Could not load announcements. Please try again later.",
      delete_failed_title: "Failed to delete",
      delete_failed_message: "Could not delete the announcement. Please try again later.",
      pagination: "{from}-{to} of {total}",
    },
    activity: { title: "Activity", fullscreen: "Fullscreen", exit_fullscreen: "Exit fullscreen" },
    modals: {
      team_workload: "Team workload",
      members_count: "{count} members",
      member_hours: "Member hours",
      hours_total: "{hours}h total",
    },
  },
  workspace_products: {
    create: {
      name_placeholder: "Name this product",
      identifier_placeholder: "e.g. KF01A008",
      description_placeholder: "What is this product? Who is it for?",
      footer_hint: "Development ID and visibility can still be changed in product settings",
    },
    identifier_copied: "Development ID copied to clipboard",
    title: "Product management",
    search_placeholder: "Search by name, project code or development ID",
    ...
    fields: {
      ...
      actions: "Actions",
      code: "Project code",
      code_hint: "Picked from the data dictionary; unique per workspace",
      stage: "Stage",
      category: "Category",
      status: "Status",
      hardware_level: "Hardware R&D level",
      hardware_level_short: "Hardware",
      structure_level_short: "Structure",
      software_level_short: "Software",
      o_phase_close_date_short: "O-phase close",
      v_phase_close_date_short: "V-phase close",
      structure_level: "Structure R&D level",
      software_level: "Software R&D level",
      start_date: "Start date",
      o_phase_close_date: "O-phase close date",
      v_phase_close_date: "V-phase close date",
    ...
    validation: {
      ...
      code_already_exists: "That project code is taken. Pick another one.",
      legacy_incomplete: "This product is missing required fields: {fields}. Fill them in before saving.",
    ...
    settings: {
      ...
      placeholder: {
        ...
        description: "This settings area is reserved and will be available in a future update.",
      },
      members: {
        page_title: "Members",
        description: "Manage the members who can access this product and their roles.",
        title: "Members",
        ...
        no_available_members: "All active workspace members have already been added to this product.",
        no_matching_available_members: "No matching members",
        remove_row: "Remove row",
        clear_filters: "Clear filters",
        roles_load_failed: "Product roles could not be loaded. Role filtering and assignment are unavailable.",
        load_failed: "Product members could not be loaded.",
        retry: "Retry",
        try_again: "Please try again.",
        empty: "No product members yet",
        empty_description: "Add active workspace members to give them explicit product access and product roles.",
        no_results: "No matching members",
        remove: "Remove",
        removing: "Removing…",
        remove_confirm_title: "Remove {name}?",
        remove_confirm_description:
          "Their product roles will be cleared. Whether they can still view this product depends on its visibility and their other access.",
        added_title: "Members added",
        added_message: "Added {count} member(s) to this product.",
        partially_added_title: "Some members were added",
        partially_added_message: "Added {succeeded}; {failed} failed. Review the remaining rows and try again.",
        add_failed_title: "Members could not be added",
        role_updated_title: "Roles updated",
        role_updated_message: "Assigned roles: {names}",
        roles_cleared_message: "Cleared all product roles for this member.",
        role_update_failed_title: "Role could not be updated",
        removed_title: "Member removed",
        removed_message: "Removed {name} from this product.",
        remove_failed_title: "Member could not be removed",
        columns: {
          full_name: "Full name",
          display_name: "Display name",
          email: "Email",
      ...
      permissions: {
        ...
        create_inline: "Create a role",
        edit: "Edit role",
        delete: "Delete role",
        load_failed: "Roles could not be loaded",
        created_title: "Role created",
        created_message: "Role “{name}” was created.",
        saved_title: "Role updated",
        saved_message: "Role details were updated.",
        deleted_title: "Role deleted",
        deleted_message: "Role “{name}” was deleted.",
        delete_failed: "Role could not be deleted",
        try_again: "Please try again.",
        delete_confirm_title: "Delete this role?",
        delete_confirm_description: "Delete role “{name}”? This action cannot be undone.",
        deleting: "Deleting…",
        form: {
          ...
          description: "Description",
          description_placeholder: "Optional: describe what this role is for",
      ...
      archive: {
        ...
        description:
          "Archived products will be removed from active navigation and can be restored later. Archiving will be available in a future update.",
        button: "Archive product",
      },
      delete: {
        title: "Delete product",
        description: "Permanently delete this product and its data. This action cannot be undone.",
    ...
    requirements: {
      ...
      fields: {
        title: "Name",
        title_placeholder: "Name this requirement set",
        description: "Description",
        description_placeholder: "Add context, goals, or acceptance notes",
        no_description: "No description",
        owner: "Owner",
        ...
        required_count: "Required approvals",
        field_count: "Fields",
        detail_count: "Records",
        updated_at: "Updated",
      },
      status: {
        draft: "Editing",
        ...
        published: "Published",
        draft_with_version: "Draft · based on v{version}",
        pending_my_approval: "Awaiting my approval",
      },
      approval: {
        toast: {
      ...
      empty: {
        ...
        description: "Create a requirement set, configure its fields, and maintain structured detail data.",
        filtered: "No matching requirements",
        filtered_description: "Adjust the search or filters to see more requirements.",
      },
      error: {
      ...
      delete: {
        ...
        description: "Delete “{name}” and all of its configured fields and data? This cannot be undone.",
      },
      tabs: {
        data: "Data",
        changes: "Change log",
      ...
      inbox: {
        ...
        reject_placeholder: "Explain why you are rejecting it — the submitter will see this",
        tabs: {
          pending: "To do",
          processed: "Done",
        },
        empty: {
          ...
          processed: "You have not acted on any change request yet",
        },
        my_action: {
      ...
      baseline: {
        ...
        error_title: "Unable to load baselines",
        total: "{count} baselines",
        entry_count: "{count} requirements",
        ...
        form: {
          ...
          description: "Only approved requirements are included. The content is frozen on creation — create a new one to update it.",
          name: "Baseline name",
          name_placeholder: "e.g. R1.0 requirements",
          summary: "Description",
          summary_placeholder: "Which release or milestone this baseline stands for",
          scope: {
            label: "Scope",
            all: "All requirements",
            by_type: "By requirement type",
          },
          preview: {
            included: "{count} requirements will be included",
            skipped: "{count} left out (never approved)",
            stale: "{count} included at an older version",
            unavailable: "Pick a scope to see what will be included",
          },
          confirm: "Create baseline",
        },
        stale_reason: {
          in_review: "{title}: in review, including v{version}",
          modified: "{title}: edited after approval, including v{version}",
        },
        detail: {
          back: "Back to baselines",
          frozen_at: "Frozen by {name} on {date}",
          all_types: "All {count}",
          deleted_type: "Deleted requirement type",
          empty: "This baseline includes no requirements",
          sub_row: "Group {index}",
        },
        compare: {
          action: "Compare these two",
          selected: "Two baselines selected",
          title: "{from} → {to}",
          total: "{count} differences",
          empty: "No differences between these baselines",
        },
        toast: {
          created: "Baseline \"{name}\" created with {count} requirements",
      ...
      data: {
        ...
        toast: {
          ...
          import_failed: "Import failed. Try again.",
        },
        views: {
          label: "Data views",
          default: "All rows",
          requirement_type_column: "Template",
          open_requirement_type_view: "Open the {name} view",
          delete_selected: "Delete selected ({count})",
          delete_one_title: "Delete this row?",
          delete_one_description: "This cannot be undone. Continue?",
          delete_many_title: "Delete the selected rows?",
          delete_many_description: "{count} rows will be deleted. This cannot be undone. Continue?",
          switch_blocked: "Save or cancel your edits before switching views.",
          empty: "No rows in this view yet.",
        },
      },
      import_modal: {
        title: "Import from a standard library",
        search_tree: "Search libraries or modules",
        no_search_result: "No matching libraries or modules",
        library_tag_empty: "No items",
        library_tag_drained: "All imported",
        includes_submodules: "Includes submodules",
        ...
        select_all_module: "Select every available item in {module} and its submodules",
        select_all_type: "Select every available item under {type}",
      ...
      state: {
        ...
        draft_banner:
          "This is a draft. Your edits do not affect the published v{version} until a change request is approved.",
        draft_notice: "Edits take effect after approval.",
        ...
        withdraw_review_description:
          "The change request is voided and the baseline returns to editing. You can submit it again after further edits.",
        toast: {
      ...
      change: {
        ...
        before: "Before",
        after: "After",
        no_field_changes: "No field changed",
        show_all_fields: "Show all fields ({count})",
        show_changed_only: "Changed only ({count})",
        based_on_version: "Based on v{version}",
        requirements_in_request: "Requirements in this change request",
        subform_row_delta: "{before} rows → {after} rows",
        subform_state: {
          created: "Added",
          updated: "Changed",
          deleted: "Removed",
        ...
        subform_row_moved: "Position {from} → {to}",
        requirement_count: "{count} requirements",
        title: "Change log",
        ...
        approved_progress: "{approved}/{total} approved",
        rejected_progress: "{count} rejected",
        total: "{count} total",
        per_page_value: "{count} / page",
        untitled: "No reason provided",
        meta_submitted: "Submitted {time}",
        meta_base_version: "Based on v{version}",
        summary: {
          total_changes: "{count} changes in this request",
          created: "{count} added",
        ...
        rule_summary: "{rule} ({total}) · {approved}/{total} approved",
        approval_state: {
          approved: "Approved",
          pending: "Pending",
          rejected: "Rejected",
        ...
        overview: {
          title: "Basic information changes",
          description: "Only requirement properties changed in this request are shown",
          reason: "Change reason",
          empty: "No basic information changed in this request",
        },
        schema_review: {
          title: "Field definition changes",
          description: "{count} structural field changes",
          changed_only: "Changed properties only",
          columns: {
            change: "Change",
            field: "Field",
          ...
          group_count: "{count} changes",
          root_field: "Top-level record field",
          child_field: "Child field in {name}",
          notice: "Field structure changes are applied after approval. Existing data is not deleted automatically.",
          empty: "No field definitions changed in this request",
        },
        detail_review: {
          title: "Record data",
          description: "{count} changed records",
        },
        change_type: {
          create: "Added",
          update: "Modified",
        ...
        empty_value: "—",
        bar: {
          effective_after: "{approved}/{total} approved · effective once {rule} sign off",
          comment_label: "Approval comment",
          comment_placeholder: "Add an approval comment (optional)",
          approve: "Approve",
          reject: "Reject",
          revert: "Also revert these changes",
        },
        filters: {
          all: "All",
          create: "Added",
          update: "Modified",
          delete: "Removed",
          changed_only: "Changed columns only",
        },
        grid: {
          change: "Change",
          range: "Showing {start}-{end} of {total}",
          per_page_value: "{count} / page",
          empty: "This change request has no record data changes",
        },
        submit: {
          title: "Submit for approval",
          description:
            "Once submitted, the requirement goes under review and becomes read-only until the change is approved.",
          reason: "Change reason",
          reason_placeholder: "Briefly explain why this change is needed",
          confirm: "Submit for approval",
        },
        toast: {
          edit_started: "A working copy is ready. You can start editing.",
          submitted: "The change request has been submitted.",
      ...
      version: {
        ...
        read_only: "Read-only",
        content_summary: "Version contents",
        reason: "Version note",
        no_reason: "No change note was provided for this release.",
        ...
        sections: {
          ...
          details: "Detail data",
          details_with_count: "Detail data {count}",
        },
        summary: {
          fields: "Fields",
          details: "Records",
        ...
        error_title: "Unable to load version history",
        snapshot_error: "Unable to load this version snapshot",
        toast: {
          rolled_back: "A draft was created from that version. Submit it for approval when ready.",
          failed: "The rollback could not be completed. Please try again.",
        },
      },
      configuration: {
        ...
        status_first_draft: "First-publish draft",
        status_published: "The current version is published and active",
        status_next_first_publish: "Submit for approval to publish the first version",
        status_next_publish: "Approved changes publish and take effect automatically",
        status_next_edit: "Future edits create a new draft that requires approval",
        custom_fields: "Custom fields",
        custom_fields_description: "Drag fields to reorder them. Select a field to configure it on the right.",
        custom_fields_read_only_description: "{count} fields. This is the structure currently in effect.",
        fields_empty: "This requirement has no custom fields.",
    ...
    projects: {
      ...
      status_distribution: "Status distribution",
      completion: "Done",
      completion_hint: "With linked work items: completed / (work items − cancelled). Otherwise by requirement status: Released / (total − Closed).",
      title: "Linked project",
      link: "Link projects",
      linked_at: "Linked on",
      error_title: "Unable to load linked projects",
      no_visible_projects: "No project in this workspace is available to link",
      ...
      empty: {
        ...
        description: "Link a project to see how it references and delivers this product's requirements.",
      },
    },
    releases: {
      title: "Release",
    ...
    features: {
      dashboard: {
        ...
        description: "Product progress, key metrics, and recent activity will be brought together here.",
      },
      requirements: {
      ...
      settings: {
        ...
        description: "Manage product details, member access, and other configuration here.",
      },
    },
    detail: {
      error_title: "Product could not be opened",
      error_description: "This product does not exist, or you do not have permission to view it.",
      back_to_products: "Back to product management",
      permission_title: "Product settings are unavailable",
      permission_description: "Only the product owner or a workspace admin can access product settings.",
    },
    empty: {
      title: "Create your first product",
      description: "Keep product context, ownership, and review responsibilities in one workspace-level list.",
      search_title: "No matching products",
      search_description: "Try a different product name or clear your search.",
    },
    error: {
      title: "Products could not be loaded",
      description: "Retry to get the latest products from this workspace.",
    ...
    toast: {
      ...
      failed: "The product could not be saved. Please try again.",
    },
  },
  workspace_projects: {
    ...
    create: {
      ...
      footer_hint: "The dev mode cannot be changed later; the ID and visibility can",
    ...
    fields: {
      ...
      code_hint: "Picked from the data dictionary; unique per workspace",
      dev_mode: "Dev mode",
      dev_mode_readonly_hint: "Chosen when the project was created and cannot be changed.",
      dev_mode_view: "View mode settings",
      network: "Visibility",
      business_unit: "Business unit",
      description: "Description",
      pms_project_name: "PMS project name",
      timezone: "Timezone",
      project_type: "Project type",
      status: "Project status",
      product_type: "Product type",
      project_lead: "Project lead",
      product_manager: "R&D product manager",
      start_date: "Start date",
      end_date: "End date",
      not_set: "Not set",
      select_placeholder: "Select",
    ...
    validation: {
      ...
      code_already_exists: "That project code is taken. Pick another one.",
      code_not_in_dictionary: "That project code is not in the data dictionary. Pick one from the list.",
      invalid_option: "The selected option is no longer available. Pick another one.",
  ...
  workspace_settings: {
    ...
    settings: {
      ...
      integrations: {
        title: "Integrations",
        description:
          "See how this workspace maps to external systems and trigger a sync by hand. Endpoints and secrets are configured by operators through server-side environment variables.",
        empty: "No third-party integrations are connected yet.",
        providers: {
        ...
        catalog: {
          jiandaoyun_project_code: {
            name: "Project codes",
            description:
              "Pulls proj_no from the Jiandaoyun project-code form into the “Project code” data dictionary. Add-only: nothing is deleted or renamed. Runs daily and on demand.",
          },
        },
        card: {
          mapping: "Mapping",
          mapping_to: "Data dictionary “{name}”",
          target_count: "({count} values)",
          target_missing: "Target dictionary missing",
          config: "Configuration",
          configured: "Configured",
          not_configured: "Not configured",
          missing_settings: "Missing server environment variables:",
          last_sync: "Last sync",
          never_synced: "Never synced",
          by_schedule: "Scheduled job",
          sync_now: "Sync now",
          syncing: "Syncing…",
        },
        summary: {
        ...
        errors: {
          ...
          INTEGRATION_NOT_CONFIGURED: "This integration is not configured yet. Ask an operator to set the server environment variables.",
          INTEGRATION_SYNC_IN_PROGRESS: "A sync is already running. Try again in a moment.",
          INTEGRATION_REMOTE_UNREACHABLE: "Could not reach the external system (timeout or network error).",
          INTEGRATION_REMOTE_UNAUTHORIZED: "The external system rejected the request. Check the token and appkey.",
          INTEGRATION_REMOTE_BAD_RESPONSE: "The external system returned data that could not be parsed.",
          INTEGRATION_TARGET_MISSING: "The target data dictionary does not exist.",
          INTEGRATION_INTERNAL_ERROR: "An internal error occurred during the sync.",
          unknown: "Sync failed. Please try again later.",
        },
      },
      stage_types: {
        title: "Stage types",
        description:
          "Review templates hang off stage types. Preset types keep their code and name; add your own and drag to reorder.",
        create: "New stage type",
        table: {
          col_code: "Code",
          col_name: "Name",
          ...
          edit: "Edit",
          delete: "Delete",
          delete_preset_blocked: "Preset types cannot be deleted",
          drag_hint: "Drag to reorder",
          drag_hint_full: "Drag the handle to reorder. Changes save on drop.",
          summary: "{total} types, {preset} of them preset",
        },
        empty: {
          title: "No stage types yet",
          description:
            "Stage types are the backbone of the review template tree. Add one, or open the template center to seed the 10 presets.",
        },
        form: {
          create_title: "New stage type",
          edit_title: "Edit stage type",
          code_label: "Code",
          code_hint: "Unique within the workspace. Presets take M010-M100 in steps of 10.",
          name_label: "Name",
          description_label: "Description",
          description_placeholder: "What this stage covers and when it applies",
          preset_locked: "Preset",
          preset_hint: "Preset types only allow editing the description and order.",
          create: "Create",
          save: "Save",
        },
        delete_modal: {
          title: "Delete stage type \"{name}\"?",
          description: "This cannot be undone. Types still used by review templates cannot be deleted.",
          confirm: "Delete",
          deleting: "Deleting...",
        },
        toast: {
          created: "Stage type created",
          updated: "Stage type updated",
          deleted: "Stage type deleted",
          delete_failed: "Could not delete \"{name}\"",
          reorder_failed: "Could not save the new order. Try again.",
        },
        errors: {
          code_required: "Enter a code",
          name_required: "Enter a name",
          load_failed: "Unable to load stage types",
          generic: "Something went wrong. Try again.",
          stage_type_code_required: "Enter a code",
          stage_type_name_required: "Enter a name",
          stage_type_code_already_exists: "That code is already taken",
          stage_type_name_already_exists: "That name is already taken",
          stage_type_system_code_readonly: "Preset types keep their code",
          stage_type_system_name_readonly: "Preset types keep their name",
          stage_type_system_protected: "Preset types cannot be deleted",
          stage_type_in_use: "Review templates still hang off this stage type. Move or delete them first.",
        },
      },
      data_dictionaries: {
        ...
        list: {
          ...
          search_placeholder: "Search dictionaries",
          system_group: "System dictionaries",
          custom_group: "Custom",
          no_match: "No matching dictionaries",
          system_badge: "System",
          custom_badge: "Custom",
        },
        detail: {
          empty_selection: "Select a dictionary on the left",
          name_label: "Name",
          name_placeholder: "Enter a dictionary name",
          description_label: "Description",
          description_placeholder: "Optional: describe what this dictionary is for",
          delete: "Delete dictionary",
          system_locked: "System dictionaries are managed by the system and cannot be deleted",
          add_value: "Add value",
          add_value_placeholder: "Type a new value and press Enter",
          delete_value: "Delete value",
          no_values: "No values yet. Add the first one.",
          drag_hint: "Drag to reorder",
          colored_toggle: "Colored display",
          color_title: "Color",
          custom_color: "Custom color",
          color_preview: "Preview",
          pick_color: "Pick a color",
          hex_placeholder: "6-digit hex",
        },
        header: {
        ...
        toolbar: {
          ...
          bulk_add: "Bulk add",
          drag_disabled_search: "Drag to reorder is unavailable while searching",
          drag_disabled_sort: "Switch to “Manual order” to drag and reorder",
        },
        table: {
          col_index: "#",
          col_value: "Value",
          col_usage: "Usage",
          col_created: "Added",
          usage_products: "{count} products",
          usage_projects: "{count} projects",
          usage_unavailable: "—",
          delete_blocked: "Still referenced by products or projects (including deleted or template ones); cannot be deleted",
          no_match: "No matching values",
          edit_value: "Edit",
          change_color: "Color",
        },
        pagination: {
          range: "{start}–{end} of {total}",
          per_page: "{size} per page",
          jump_to: "Go to",
          page: "page",
          prev: "Previous page",
          next: "Next page",
        ...
        bulk_modal: {
          title: "Bulk add to “{name}”",
          description: "One value per line. Duplicates and surrounding spaces are removed automatically.",
          placeholder: "Paste or type values, one per line",
          preview_new: "{count} new values will be added",
          preview_existing: "{count} already exist and will be skipped: {labels}",
          preview_more: "… and {count} more",
          limit: "Up to {max} values at a time",
          submit: "Add {count} values",
        },
        colors: {
          gray: "Gray",
          red: "Red",
        ...
        create_modal: {
          ...
          key_label: "Dictionary key",
          key_placeholder: "e.g. product_region",
          key_hint:
            "Starts with a lowercase letter; lowercase letters, digits and underscores only; up to 64 characters. Cannot be changed after creation.",
          name_label: "Name",
          name_placeholder: "e.g. Product region",
          description_label: "Description",
          submit: "Create",
        },
        delete_modal: {
          title: "Delete this dictionary?",
          description: "Delete dictionary “{name}” and all of its values? This cannot be undone.",
          confirm: "Delete",
          deleting: "Deleting…",
        },
        delete_item_modal: {
          title: "Delete this value?",
          description: "Delete “{label}”? Values referenced by products or projects cannot be deleted.",
        },
        toast: {
          created: "Dictionary created",
          updated: "Dictionary updated",
          deleted: "Dictionary deleted",
          item_created: "Value added",
          items_bulk_created: "{created} values added, {skipped} skipped",
          item_updated: "Value updated",
          item_deleted: "Value deleted",
          reordered: "Order updated",
          failed: "Something went wrong. Please try again.",
          load_failed: "Data dictionaries could not be loaded",
        },
        errors: {
          key_required: "Enter a dictionary key",
          key_invalid:
            "The key must start with a lowercase letter and contain only lowercase letters, digits and underscores (max 64 characters).",
          key_already_exists: "That key already exists",
          name_required: "Enter a dictionary name",
          name_already_exists: "That name already exists",
          label_required: "Value cannot be empty",
          item_already_exists: "That value already exists",
          system_protected: "System dictionaries cannot be deleted",
          item_in_use: "This value is already referenced and cannot be deleted",
        },
      },
      api_tokens: {
  ...
  profile: {
    ...
    stats: {
      ...
      overdue_description: "Overdue work items that are still open.",
      greeting: {
        morning: "Good morning, {name}",
        afternoon: "Good afternoon, {name}",
        evening: "Good evening, {name}",
        member: "Team member overview",
      },
      dashboard_title_self: "Your work cockpit",
      dashboard_title_member: "Member work snapshot",
      dashboard_description: "A focused view of due work, completion pace, and priority pressure.",
      workbench: {
        items: "items",
        today_due_hint: "Work due today and overdue work that still needs attention.",
        week_due_hint: "Work due by the end of this week, including overdue work.",
        health_headline: "Momentum signal",
        health_description:
          "Completion health blends finished work with overdue pressure to show whether the current pace is sustainable.",
        focus_strip: "Focus strip",
        focus_strip_hint: "Risk, output, and planning quality at a glance.",
      },
      today_pending: "Due today",
      today_pending_description: "Open work items due today or already overdue.",
      week_pending: "Due this week",
      week_pending_description: "Open work items due by the end of this week, including overdue items.",
      pending_approval: "Pending approval work items",
      pending_approval_description: "Work items with state transitions that are still awaiting this member's approval.",
      pending_execution_cases: "Pending test cases",
      pending_execution_cases_description: "Plan cases assigned to this member that have not been executed yet.",
      pending_review_cases: "Pending test case reviews",
      pending_review_cases_description: "Review cases assigned to this member that still require a review decision.",
      responsible_cycles: "Responsible cycles",
      responsible_cycles_description: "Cycles created by or currently owned by this member.",
      responsible_releases: "Responsible releases",
      responsible_releases_description: "Releases created by or currently led by this member.",
      open_assigned_requirements: "Responsible requirements",
      open_assigned_requirements_description: "Requirements assigned to this member that are not yet released or closed.",
      overdue_requirements: "Overdue requirements",
      unscheduled_requirements: "Unscheduled requirements",
      pending_requirement_approvals: "Requirement reviews",
      pending_requirement_approvals_description: "Requirement change requests awaiting this member's review.",
      overview_sections: {
        deadlines: {
          title: "Deadlines and risk",
          description: "Upcoming commitments and overdue work that can affect your current pace.",
        },
        queue: {
          title: "Pending queues",
          description: "Work queues that still need a decision, schedule, or execution.",
        },
        responsibility: {
          title: "Responsibility scope",
          description: "Cycles and releases created by or currently owned by this member.",
        },
        coverage: {
          title: "Work coverage",
          description: "How this member's work is distributed across assignment, creation, and subscription.",
        },
      },
      metric_details: {
        all_projects: "All projects",
      ...
      contribution: {
        ...
        subtitle: "Distribution of completed work items across projects.",
        total_label: "Completed",
        tooltip_label: "Work items",
        empty: "No completed work items yet",
      },
      health: {
        title: "Completion health",
        desc: "Score blends completion rate (70%) with on-time pending work (30%).",
        levels: {
          excellent: "Excellent",
          good: "Good",
          fair: "Fair",
      ...
      health_check: {
        title: "Health check",
        no_data_title: "Not enough work data yet",
        no_data_description: "Assign work items to this member before evaluating their work health.",
        score_label: "Personal work health",
        score_unit: "Score",
        rules_aria: "View health check rules",
        rules_title: "Check rules",
        rules_description:
          "Health score combines completion progress, overdue risk, schedule coverage, priority pressure, and recent output across 5 health levels.",
        rules: {
          completion:
            "Score >= 90 is excellent, 75-89 is healthy, 60-74 needs attention, 45-59 is at risk, and below 45 is critical.",
          overdue:
            "Overdue work above 5% of pending items prevents excellent, 15% needs attention, 25% is at risk, and 35% is critical.",
          schedule:
            "Schedule coverage below 80% prevents excellent, below 60% needs attention, and more unscheduled work reduces the score further.",
          pressure:
            "High-priority share adds pressure; if pending work exists but nothing was completed this week, recent output reduces the score.",
        },
        levels: {
          excellent: {
            label: "Excellent",
            description: "Work pace is highly stable, with overdue, schedule, and recent output all in good shape.",
          },
          healthy: {
            label: "Healthy",
            description: "Work pace is stable with only light pressure signals, and current risk is under control.",
          },
          watch: {
            label: "Needs attention",
            description: "Some overdue, unscheduled, or slower output signals exist. Clear blockers first.",
          },
          risk: {
            label: "At risk",
            description: "Overdue or progress lag is significant, and the current pace needs adjustment.",
          },
          critical: {
            label: "Critical risk",
            description: "Overdue pressure or progress lag is heavy. Address key blockers immediately.",
          },
        },
        metrics: {
          completion: {
            title: "Completion",
            description: "Completed work items as a share of all assigned work items.",
          },
          overdue: {
            title: "Overdue",
            description: "Overdue work items as a share of pending work items.",
          },
          schedule: {
            title: "Schedule",
            description: "Pending work items that already have a due date.",
          },
          priority: {
            title: "High priority",
            description: "Urgent or high priority work items as a share of pending work.",
          },
          momentum: {
            title: "Done this week",
            description: "Assigned work items completed since Monday.",
            detail: "This week",
          },
        },
      },
      focus: {
        ...
        defects_description: "Defects assigned to you that are still open.",
      },
      assigned_lists: {
        title: "My backlog",
        defects_title: "My defects",
      ...
      requirements: {
        ...
        distribution_title: "Delivery distribution",
        distribution_subtitle: "Requirements assigned to you, by delivery status and review state.",
        open_of_total: "open · {total} in total",
        approval_title: "Review state",
        overdue: "Overdue requirements",
        unscheduled: "Unscheduled",
        issue_completion: "Linked work item completion",
        list_title: "My requirements",
        list_hint: "open",
        empty: "No requirements assigned to you",
        all_products: "All products",
        page_empty_title: "No requirements assigned to this member yet",
        page_empty_description: "Product requirements assigned to this member will be listed here across products.",
      },
      workload_overview: {
        title: "Workload & progress",
        state_title: "Work items by state",
        state_description: "State distribution of your open assigned work.",
        open_items: "Open",
        empty: "No data yet",
        today_done: "Done today",
        week_done: "Done this week",
        high_priority: "High priority",
      },
      progress: {
        title: "Completion progress",
        subtitle: "Completed work against all assigned work items.",
        completed: "Completed",
        remaining: "Remaining",
        pending: "Pending",
        overdue: "Overdue",
      ...
      insights: {
        ...
        high_priority: "High priority",
        high_priority_description: "Urgent or high priority items still open.",
        completed_today: "Done today",
        completed_today_description: "Assigned items completed today.",
        completed_this_week: "Done this week",
        completed_this_week_description: "Assigned items completed since Monday.",
        unscheduled: "Unscheduled",
        unscheduled_description: "Open items without a due date.",
        schedule_coverage: "Schedule coverage",
        schedule_coverage_description: "Pending items with a due date.",
      },
      state_distribution: {
  ...
  project_settings: {
    ...
    issue_types: {
      ...
      placeholder: {
        ...
        description:
          "You will be able to create and manage project work item types, icons, and related properties here.",
      },
    },
    labels: {
      heading: "Labels",
    ...
    automations: {
      ...
      pms_sync: {
        ...
        description: "Manage sub-project and version metadata used for PMS synchronization.",
        add: "Add configuration",
        edit: "Edit configuration",
        empty_title: "No PMS sync entries yet",
        empty_description: "Use “Add configuration” at the top to enter sub-project, code, meter type, and versions.",
        sub_project: "Sub-project name",
        project_code: "Project code",
        meter_type: "Meter / product type",
        ...
        delete_confirm_title: "Delete this configuration?",
        delete_confirm_description: "This cannot be undone. Continue?",
        cancel: "Cancel",
        save: "Save",
        create: "Create",
        table_hint: "Review and manage all PMS sync rows in the table below.",
        validation_required: "Please fill in all text fields.",
        toast_created: "Created",
        toast_saved: "Saved",
        toast_deleted: "Deleted",
        toast_error: "Something went wrong. Please try again.",
        toast_delete_error: "Could not delete. Please try again.",
        loading: "Loading…",
        delete_loading: "Deleting…",
        sync_action: "Sync to PMS",
        sync_success: "Sync completed",
        sync_partial_warning: "Some work items could not be synced to PMS. See the list below.",
        sync_error: "Sync failed. Please try again.",
        sync_failed_title: "Work items that failed to sync",
        sync_failed_dismiss: "Dismiss list",
      },
      "auto-close": {
    ...
    features: {
      ...
      releases: {
        ...
        description: "Plan what ships together and track it to the release date.",
        toggle_title: "Enable releases",
        toggle_description: "Project members will be able to create releases and plan their scope.",
      },
      views: {
        title: "Views",
        short_title: "Views",
      ...
      reviews: {
        title: "Reviews",
        short_title: "Reviews",
        description: "Tailor which reviews each stage needs, then run them.",
        toggle_title: "Enable reviews",
        toggle_description: "Project members will be able to tailor and run stage reviews.",
      },
      not_supported_by_dev_mode: "Not available in the current dev mode",
      view_dev_mode: "Open in template center",
    },
  },
  project_cycles: {
    add_cycle: "Add cycle",
  ...
  project_module: {
    ...
    delete_confirmation: {
      ...
      after_name: "? All of the data related to the module will be permanently removed. This action cannot be undone.",
    },
    empty_state: {
      general: {
  ...
  project_release: {
    ...
    tab_release_scope: "Scope",
    add_release: "Add release",
    created_success: "Release created successfully.",
