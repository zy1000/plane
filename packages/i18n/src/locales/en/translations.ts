...
export default {
  ...
  review_tailoring: {
    ...
    empty: {
      ...
      description: "Create a tailoring, pick a stage, then select the reviews each product needs.",
    ...
    form: {
      ...
      stage_empty: "This workspace has no review templates yet. Configure them in the template center first.",
      stage_hint: "Only stages with review templates are listed",
      products_label: "Products",
      products_required: "Select at least one product",
      products_empty: "This project has no linked products. Link them on the Products page first.",
      select_all: "Select all",
    ...
    activity: {
      ...
      items_synced: "synced templates: {added} added, {removed} removed",
    ...
    errors: {
      ...
      REVIEW_TAILORING_PRODUCT_REQUIRED: "Select at least one product",
      REVIEW_TAILORING_STAGE_NO_TEMPLATE: "This stage has no review templates yet",
