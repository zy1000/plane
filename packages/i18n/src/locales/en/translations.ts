...
export default {
  ...
  stage_review: {
    ...
    detail: {
      ...
      created_at: "创建于 {date}",
      add_description: "写清楚这条评审要核对什么、对照哪份文件",
      add_work_instruction: "Click to add work instructions",
    ...
    actions: {
      start: "开始评审",
      hint_not_started: "开始后进入「评审中」，由负责人推进",
      hint_in_review: "提交时填写评审结果",
      hint_in_approval: "审核通过后评审完成",
      hint_in_review_rejected: "上次评审不通过，整改后重新提交审核",
      hint_completed: "已评审，记录已定稿；要重做请在裁剪表取消勾选后重新生成",
      completed_by: "已于 {date} 由 {name} 审核通过",
      submit_for_approval: "提交审核",
      approve: "审核通过",
      rollback_plain: "退回",
      blocked_no_leader: "还没有负责人，先指定负责人才能推进",
      blocked_no_auditor: "还没有审核者，先指定审核者才能继续",
      blocked_not_leader: "这一步由负责人 {name} 推进",
      blocked_not_auditor: "这一步由审核者 {name} 审核",
      blocked_rollback_not_leader: "只有负责人 {name} 能退回",
      blocked_rollback_not_auditor: "只有审核者 {name} 能退回",
      close: "关闭",
      cancel: "取消",
      delete: "删除",
    },
    submit: {
      ...
      effect_approval_no_auditor: "提交后进入审核中，等待审核者完成审核。",
    ...
    errors: {
      ...
      STAGE_REVIEW_AUDITOR_REQUIRED: "还没有审核者，先指定审核者才能继续",
  ...
  review_tailoring: {
    ...
    activity: {
      ...
      empty_description: "Creating, selecting, approving and taking effect are all recorded here.",
      created: "created the tailoring {title}",
      ...
      cell_selected_on: "selected {title}",
      cell_selected_off: "unselected {title}",
      cell_reason: "updated the tailoring reason for {title}",
      submitted: "submitted approval round {round}",
      approved_partial: "approved ({value})",
      applied: "approved and took effect: {created} reviews created, {deleted} removed",
