...
export default {
  ...
  workspace_products: {
    ...
    search_placeholder: "Search by name, product code or development ID",
    ...
    fields: {
      ...
      actions: "Actions",
      code: "Product code",
      code_placeholder: "e.g. Cedar28B-032501-水",
      code_hint: "Unique per workspace",
      stage: "Stage",
      category: "Category",
      status: "Status",
    ...
    validation: {
      ...
      code_already_exists: "That product code is taken. Pick another one.",
