...
export default {
  ...
  project_requirements: {
    ...
    stage_reason: {
      ...
      in_progress: "Manually marked as in progress",
      done: "Manually marked as developed",
      released: "Shipped in release {name}",
    },
    stage_locked_hint: "Already in a release — remove it from the release to change the stage",
