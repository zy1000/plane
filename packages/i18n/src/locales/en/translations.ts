  ...
  workspace_settings: {
    ...
    settings: {
      ...
      data_dictionaries: {
        ...
        description:
          "Maintain the dropdown values for product stage, category, status and more. System dictionaries cannot be deleted, but their values can be edited freely.",
        list: {
          title: "Dictionaries",
        ...
        detail: {
          ...
          values_title: "Values",
          values_description:
            "Drag to reorder. This is the order shown in forms. With colored display on, values appear as colored tags wherever this dictionary is used.",
          add_value: "Add value",
        ...
        delete_item_modal: {
          ...
          description: "Delete “{label}”? Values referenced by products cannot be deleted.",
        },
        toast: {
