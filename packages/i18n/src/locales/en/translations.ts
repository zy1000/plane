...
export default {
  ...
  workspace_templates: {
    ...
    requirements: {
      ...
      create_description: "Start with the name and owner, then configure its fields.",
      edit: "Configure",
      ...
      list: {
        ...
        empty_filtered_description: "Try another search term or reset the current filters.",
      ...
      validation: {
        name_owner_required: "Enter a template name and select an owner.",
      ...
      editor: {
        ...
        basic_description: "Set the template identity, owner, lifecycle, and availability.",
