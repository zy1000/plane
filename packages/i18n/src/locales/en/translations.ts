...
export default {
  ...
  stage_review: {
    ...
    actions: {
      ...
      completed_waived_by: "已于 {date} 由 {name} 免审完成",
    ...
    submit: {
      title: "提交审核",
      description: "结论决定下一步：通过 / 条件通过进入审核，不通过留在评审中，免审直接完成。",
      ...
      effect_waived: "免审：提交后直接完成评审，不经审核。",
      result: "评审结果",
      reason: "结论说明",
