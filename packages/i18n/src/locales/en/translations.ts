...
export default {
  ...
  stage_review: {
    ...
    errors: {
      ...
      STAGE_REVIEW_STAGE_NOT_IN_MODE: "目标阶段不在本项目的研发模式里",
  ...
  review_tailoring: {
    ...
    actions: {
      ...
      add_reviews_empty_process: "The development mode has no process reviews or activities left to add",
      add_reviews_empty_o_stage: "The development mode has no O-stage reviews or activities left to add",
    ...
    errors: {
      ...
      REVIEW_TAILORING_STAGE_NOT_IN_MODE: "The target stage is not in this project's development mode",
      ...
      REVIEW_TAILORING_TEMPLATE_NOT_IN_MODE: "Some reviews are not enabled by the project's development mode",
      REVIEW_TAILORING_MODE_HAS_NO_STAGE: "The project's development mode has no stages, so no tailoring can be created",
    },
  },
  workspace_templates: {
    ...
    dev_modes: {
      ...
      errors: {
        ...
        dev_mode_stage_in_use: "Stage {names} is used by a tailoring table or a review. Handle it in the project first.",
