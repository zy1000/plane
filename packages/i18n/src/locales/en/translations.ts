...
export default {
  ...
  requirement_libraries: {
    ...
    create_description: "A library is based on one requirement template. Every item in it shares that template's fields.",
    fields: {
      name: "Library name",
    ...
    empty: {
      ...
      description: "A library builds on a requirement template to collect a set of consistently structured items.",
    },
    list: {
    ...
    detail: {
      template_tooltip: "Every item in this library shares this template's fields. Open the template.",
    ...
    requirements: {
      ...
      data: {
        ...
        views: {
          ...
          open_template_view: "Open the {name} view",
      ...
      import_modal: {
        ...
        library_meta: "{template} · {count} items",
      ...
      template_picker: {
        title: "Choose a requirement template",
        description: "The row's fields come from the template you pick.",
        search: "Search templates",
        empty: "No requirement templates available",
      ...
      configuration: {
        ...
        fields_moved_hint: "Field structure is now managed under Templates → Requirement templates.",
