...
export default {
  ...
  requirement_libraries: {
    ...
    create_description: "A library is based on one requirement template. Everything in it shares that template's fields.",
    fields: {
      name: "Library name",
      name_placeholder: "e.g. Payment API library",
      template: "Requirement template",
      template_placeholder: "Pick a requirement template",
      template_hint: "Cannot be changed later — switching templates would invalidate all data in the library.",
      description: "Description",
    ...
    validation: {
      ...
      template_required: "Pick a requirement template.",
      requirement_title_required: "Enter a title.",
    },
    empty: {
      title: "No standard libraries yet",
      description: "A library builds on a requirement template to collect a set of consistently structured requirements.",
    },
    list: {
      search_placeholder: "Search libraries",
      reset_view: "Reset view",
      filtered_by: "Filtered by:",
      clear_template_filter: "Clear template filter",
      template_filter_fallback: "Selected template",
      updated_at: "Updated",
      ...
      delete_blocked: "Remove the {count} standard requirements in this library first.",
    ...
    detail: {
      template_tooltip: "Everything in this library shares this template's fields. Open the template.",
      total: "{count} standard requirements",
      empty_title: "No standard requirements yet",
      empty_description: "Requirements created here use the fields defined by {template}.",
      select_all: "Select all requirements",
      select_requirement: "Select {name}",
      delete_selected: "Delete selected ({count})",
      delete_many_title: "Delete these requirements?",
      delete_many_description: "Delete {count} standard requirements? Their detail data will be removed too. This cannot be undone.",
      delete_success: "Deleted {count} standard requirements.",
      delete_requirement: "Delete {name}",
      delete_title: "Delete standard requirement?",
      delete_description_prefix: "Are you sure you want to delete ",
      delete_description_suffix: "? Its detail rows will be removed too. This action cannot be undone.",
      error_title: "Unable to load standard requirements",
    },
    requirements: {
      title: "Standard requirement",
      create: "New standard requirement",
      create_and_fill: "Create and enter data",
      create_description: "Will use the {count} fields from {template}.",
      fields: {
        title: "Title",
        title_placeholder: "e.g. Create payment order API",
        owner: "Owner",
        detail_count: "Rows",
      },
    ...
    toast: {
      ...
      requirement_created: "Standard requirement created.",
      requirement_deleted: "Standard requirement deleted.",
      requirement_failed: "Something went wrong. Try again.",
    },
  },
  workspace_templates: {
    ...
    requirements: {
      ...
      create_description: "Name the template, then configure its custom fields.",
      switch_template: "Switch requirement template",
      active: "Active",
      inactive: "Inactive",
      delete_confirm: "Delete this requirement template and all of its data?",
      empty: {
      ...
      list: {
        ...
        previous_page: "Previous page",
        next_page: "Next page",
        select_page: "Select all templates on this page",
        select_template: "Select {name}",
        delete_template: "Delete {name}",
        delete_selected: "Delete selected ({count})",
        delete_one_title: "Delete requirement template?",
        delete_many_title: "Delete requirement templates?",
        ...
        delete_many_description:
          "Are you sure you want to delete these {count} requirement templates? All related data will be permanently removed. This action cannot be undone.",
        delete_success: "{count} requirement templates deleted.",
        empty_filtered_title: "No matching templates",
        empty_filtered_description: "Try another search term or clear the current search.",
        error_title: "Unable to load requirement templates",
        field_count: "Fields",
        used_by: "Used by",
        used_by_count: "{count} libraries",
        not_used: "Not used",
        delete_blocked: "In use by {count} standard libraries. Remove or re-point them first.",
      },
      error: {
        title: "Unable to load this requirement template",
      },
      toast: {
        created: "Requirement template created.",
        deleted: "Requirement template deleted.",
        saved: "Requirement template saved.",
        failed: "The operation could not be completed.",
      },
      validation: {
        name_required: "Enter a template name.",
        required_count: "The required approval count must be within the number of selected approvers.",
      ...
      fields: {
        ...
        active_description: "Active templates can be selected when creating requirements.",
        description: "Description",
        description_placeholder: "Explain when and how this template should be used.",
      ...
      editor: {
        title: "Configure requirement template",
        configuration: "Configuration",
        unsaved: "Unsaved",
        preview: "Preview",
        close_preview: "Close preview",
        fields_description: "Drag fields to reorder them. Child fields stay within their repeatable form.",
        approval_description: "Choose who can approve requirements created from this template.",
        discard_confirm: "Discard your unsaved template changes?",
        ...
        conflict_description: "Someone else updated this template. The latest version has been loaded.",
        settings: "Template settings",
        settings_description: "Name, description, and overview.",
        overview: "Overview",
        owner: "Owner",
        created_at: "Created",
        ...
        builder: {
          ...
          copy_suffix: " copy",
          empty_description: "Choose a field from the library to start building this template.",
      ...
      approval: {
        ...
        any: "Any approver",
        all: "All approvers",
        n_of_m: "A required number",
        any_description: "The first approval completes the approval step.",
        all_description: "Every selected approver must approve.",
        n_of_m_description: "A specified number of selected approvers must approve.",
        approvers: "Approvers",
        select_approvers: "Select approvers",
        required_count: "Required approvals",
        required_count_description: "Choose a value between 1 and {count}.",
      },
      preview: {
        title: "Field preview",
        description: "This is how the two-level header will appear on the data page.",
        empty: "Records entered with this template will appear here.",
      },
      filters: {
        contains: "Contains",
        equals: "Equals",
      ...
      data: {
        ...
        no_fields: "This template has no active fields",
        ...
        conflict: "Some records or the template structure changed. Reload the latest data before continuing.",
  ...
  workspace_products: {
    ...
    requirements: {
      ...
      approval: {
        ...
        any: "Any approver",
        any_description: "Best for a fast review",
        all: "All approvers",
        all_description: "Best for a strict review",
        n_of_m: "A minimum number",
        n_of_m_description: "Set a custom approval threshold",
      ...
      modal: {
        ...
        create_description: "Define the requirement set, import optional template data, and configure approval.",
        ...
        create_and_configure: "Create and configure",
        wizard: {
          subtitle: "Complete the requirement details, initial data, and approval settings step by step.",
          progress: "Requirement creation progress",
          previous: "Previous",
          next: "Next",
          steps: {
            basic: {
              title: "Basic information",
              description: "Name, description, and owner",
            },
            template: {
              title: "Template and data",
              description: "Optional initialization",
            },
            approval: {
              title: "Approval settings",
              description: "Approvers and pass rule",
            },
          },
          blank: {
            title: "Start with a blank requirement",
            description: "You can configure custom fields after the requirement is created.",
          },
          summary: {
            ...
            edit: "Return to edit details",
            basic_hint: "Complete the required information, then continue to choose how to initialize the requirement.",
            template_hint: "The template's field structure is copied into an independent configuration on create.",
          },
        },
      },
      import: {
        no_template: "Start without a template",
        fields: "Import custom fields",
        fields_description: "Copy the template field structure into an independent configuration.",
        summary: "{fields} custom fields",
        excludes: "Only fields and data are copied. Basic information and approval settings are not inherited.",
      },
      validation: {
