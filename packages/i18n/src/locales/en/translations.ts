  ...
  profile: {
    ...
    stats: {
      ...
      workbench: {
        ...
        health_description: "Completion health blends finished work with overdue pressure to show whether the current pace is sustainable.",
  ...
  disabled_project: {
    empty_state: {
      ...
      cycle: {
        ...
        description:
          "Break work down by timeboxed chunks, work backwards from your project deadline to set dates, and make tangible progress as a team. Enable the sprints feature for your project to start using them.",        primary_button: {
          text: "Manage features",
        },
      },
      module: {
