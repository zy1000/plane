...
export default {
  ...
  review_tailoring: {
    ...
    items: {
      ...
      bulk_reason: "Fill reasons in bulk",
      bulk_reason_title: "Pick the items to fill",
      bulk_reason_apply: "Apply to {count} items",
      bulk_scope_missing: "Tailored items missing a reason",
      bulk_scope_visible: "Tailored items in the current filter",
      bulk_scope_count: "{count} items",
