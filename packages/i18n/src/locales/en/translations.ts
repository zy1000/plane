...
export default {
  ...
  stage_review: {
    ...
    table: {
      ...
      dates: "计划日期",
      attachments: "附件",
      group_progress: "{completed} / {total} 已评审",
      manual: "手工",
    },
    filters: {
      all: "全部",
    ...
    empty: {
      title: "这个阶段还没有评审",
      description: "裁剪表签批生效后，勾中的格子会变成这里的一条条评审；也可以手工新建一条补充。",
    },
    fields: {
      product: "产品",
      stage: "评审阶段",
    ...
    detail: {
      ...
      add_work_instruction: "评审前准备什么、会上逐条过什么、结论怎么落",
      ...
      work_instruction_placeholder: "评审前要准备什么、会上逐条过什么、结论怎么落…",
      finished_goods: "成品",
    ...
    actions: {
      start: "开始评审",
      hint_not_started: "开始后进入评审中，由负责人推进",
      hint_in_review: "提交时需填写评审结果",
      hint_in_approval: "审核者确认结论后本条评审完成",
    ...
    submit: {
      title: "提交审核",
      description: "提交后进入审核中，由 {auditor} 完成审核。",
      description_no_auditor: "提交后进入审核中，等待审核者完成审核。",
      result: "评审结果",
      conditional_reason: "条件通过原因",
      conditional_reason_placeholder: "写明放行条件与关闭时间",
      production_mode: "生产方式",
      shipment_assessment: "出货评估",
    },
    create: {
      title: "手工新建评审",
      description: "新建在「{stage}」下。手工新建的评审不进裁剪表，也不会被裁剪表的修订删掉。",
      pick_product: "选择产品",
      parent: "所属评审",
      no_parent: "不挂在评审下",
      kind_locked: "挂在「{parent}」下，类型自动为「{kind}」",
      title_placeholder: "例如：需求评审（硬件&整机）",
    },
    delete: {
      title: "删除评审",
      content: "确认删除「{title}」？它下面的评审活动、评论与附件会一起删除，且不可恢复。",
    },
    toast: {
      created: "评审已创建",
      deleted: "评审已删除",
    ...
    activity: {
      ...
      comment: "发表了评论",
      attachment_created: "上传了附件 {name}",
      attachment_deleted: "删除了附件 {name}",
      created: "创建了这条评审",
      updated: "修改了{field}",
    },
    errors: {
      STAGE_REVIEW_RESULT_REQUIRED: "提交审核前要先选评审结果",
      STAGE_REVIEW_CONDITIONAL_REASON_REQUIRED: "条件通过必须填写原因",
