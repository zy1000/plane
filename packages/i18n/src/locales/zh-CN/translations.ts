...
export default {
  ...
  workspace_templates: {
    ...
    requirements: {
      ...
      create_description: "先填写名称与负责人，再继续配置字段。",
      edit: "配置模板",
      ...
      list: {
        ...
        empty_filtered_description: "请尝试其他关键词，或重置当前筛选条件。",
      ...
      validation: {
        name_owner_required: "请填写模板名称并选择负责人。",
      ...
      editor: {
        ...
        preview: "预览",
        close_preview: "关闭预览",
        basic_description: "设置模板标识、负责人、生命周期和可用状态。",
