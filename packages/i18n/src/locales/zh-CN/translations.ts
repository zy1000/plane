  ...
  workspace_templates: {
    ...
    requirements: {
      ...
      editor: {
        ...
        builder: {
          field_library: "字段库",
          field_library_description: "点击或拖拽字段添加到模板。",
          search_fields: "搜索字段",
          basic_fields: "基础字段",
          media_fields: "媒体字段",
      ...
      modal: {
        ...
        wizard: {
          ...
          summary: {
            ...
            template_hint: "创建时会将模板数据复制为独立的字段与明细记录。",
          },
        },
      },
      import: {
        ...
        details: "导入明细数据",
        details_description: "复制模板已有数据，并重新映射字段标识。",
        summary: "{fields} 个自定义字段 · {details} 条数据",
