...
export default {
  ...
  review_tailoring: {
    ...
    actions: {
      ...
      add_products: "添加产品",
      add_reviews: "添加评审",
      add_reviews_empty_process: "研发模式里没有可加的过程评审或评审活动",
      add_reviews_empty_o_stage: "研发模式里没有可加的 O 阶段评审或 O 阶段评审活动",
    ...
    errors: {
      ...
      REVIEW_TAILORING_STAGE_NOT_IN_MODE: "目标阶段不在本项目的研发模式里",
      ...
      REVIEW_TAILORING_TEMPLATE_NOT_IN_MODE: "有评审没有被本项目的研发模式启用",
      REVIEW_TAILORING_MODE_HAS_NO_STAGE: "本项目的研发模式还没有配置阶段，无法建裁剪表",
    },
  },
  stage_review: {
    title: "阶段评审",
