...
export default {
  ...
  requirement_fields: {
    ...
    validation: {
      ...
      duplicate_field_name: "字段名「{name}」重复，请修改后再保存。",
      duplicate_field_name_in_bin: "字段名「{name}」与回收站中的字段重复，请先改名或永久删除回收站中的字段。",
    },
    builder: {
      field_library: "字段库",
      search_fields: "搜索字段",
    ...
    recycle_bin: {
      title: "回收站",
      summary: "{count} 个字段已移入。字段定义与已录入的值都保留，恢复后立即回到字段结构。",
      empty: "回收站是空的",
      empty_hint: "从字段菜单「移入回收站」的字段会出现在这里。",
      column_name: "字段名",
      column_type: "类型",
      column_values: "有值需求",
      column_actions: "操作",
      value_count: "{count} 条",
      no_values: "暂无数据",
      footer_hint: "恢复或永久删除都在点击「保存」后生效",
      delete_permanently: "永久删除",
      delete_title: "永久删除字段",
      delete_description: "永久删除「{name}」后，所有需求中该字段已录入的数据将在保存时被清除，且无法恢复。",
      delete_description_with_count:
        "「{name}」在 {count} 条需求中有数据，永久删除并保存后这些数据将被清除，且无法恢复。",
    },
    preview: {
      title: "字段预览",
  ...
  requirement_detail: {
    ...
    /** 抽屉底部「历史」区块：一条时间线，通过的改动就是版本节点 */
    history: {
      label: "历史",
      empty: "还没有历史",
      empty_description: "提交评审后，每次通过、驳回和形成的版本都会记在这里。",
      meta: "{versions} 个版本 · {changes} 次改动",
      filter: {
        all: "全部",
        versions: "只看版本",
        schema: "结构变更",
      },
      filter_empty: "当前过滤下没有条目",
      show_all: "显示全部",
      hidden_summary: "已隐藏 {changes} 次未成为版本的改动和 {schema} 次结构变更",
      load_error: "版本信息加载失败，部分操作不可用",
      ...
      action: {
        create: "新建了本条需求",
        update: "修改了 {count} 处",
        update_generic: "提交了一次改动",
        delete: "删除了本条需求",
      },
      approval: {
        pending: "等待 {names} 审批 · {rule}",
        pending_generic: "等待审批 · {rule}",
        /** 用「已通过」不用「全部通过」：any 规则下只有一人通过 */
        approved: "{names} 已通过 · {time}",
        approved_generic: "已通过 · {time}",
        rejected: "{name} 驳回：“{comment}”",
        rejected_no_comment: "{name} 驳回",
        cancelled: "提交人撤回了评审",
        none: "无需评审，提交即生效",
      },
      diff: {
        ...
        full: "完整对比",
        hide_full: "收起完整对比",
        relative_to: "相对 v{version}",
        added: "新增",
        removed: "删除",
        subform_changed: "子表单「{name}」有变化，见完整对比",
        format_only: "仅格式调整，文字未变",
        unavailable: "这次改动没有留下可比较的快照",
      },
      actions: {
        view_snapshot: "查看这一版",
        hide_snapshot: "收起这一版",
        compare_previous: "与 v{version} 并排对比",
        hide_compare: "收起对比",
        rollback: "回滚到 v{version}",
      },
      compare: {
        button: "对比两版",
        button_disabled: "至少要有两个版本才能对比",
        from: "较早的版本",
        to: "较新的版本",
      ...
      schema: {
        group: "需求类型「{name}」的字段结构调整了 {count} 次",
        single: "调整了需求类型「{name}」的字段结构",
        scope: "需求类型级变更，对该类型全部需求生效，不经过评审",
        op_create: "新增",
        op_update: "修改",
        op_delete: "删除",
        expand: "展开",
  ...
  requirement_grid: {
    ...
    data: {
      ...
      add: "添加需求",
      title_placeholder: "一句话说明这条需求要求什么",
      description_placeholder: "补充背景、验收标准…",
      pick_type_hint: "类型决定后面会出现哪些字段",
      /** 建行弹窗：标题栏、分组、必填三层提示 */
      context_library: "需求标准库",
      context_product: "产品需求",
      required_legend: "为必填项",
      optional: "选填",
      basic_section: "基本信息",
      attributes_section: "需求属性",
      attributes_from_type: "来自需求类型「{type}」",
      properties_rail: "属性",
      pending_prefix: "待完成：",
      date_none: "未选",
      code_hint: "库内唯一，保存后仍可修改",
      title_required: "写一句标题才能保存",
      field_required: "{field}不能为空",
      select_required: "请选择{field}",
      required_progress_all: "还有 {count} 项必填未填写",
      required_missing_prefix: "还差 ",
      required_separator: "、",
      required_done: "必填项已填写完整",
      priority_none: "无",
      parent_none: "未选择",
      new: "新增",
      copy_badge: "副本",
  ...
  requirement_excel: {
    ...
    upload: {
      ...
      rule_module:
        "「模块」填模块名称，子模块用 / 分隔（如 账户/登录）；不存在的模块会自动逐级创建。留空表示放在「全部需求」下；已有需求清空该格即移回「全部需求」。名称本身含 / 的模块只能引用已有的。",
  ...
  review_tailoring: {
    ...
    empty: {
      title: "还没有裁剪表",
      description: "裁剪表是一张「评审 × 产品」的勾选矩阵。勾上的评审签批生效后会生成到阶段评审里，没勾的写清楚原因。",
      filtered: "没有符合条件的裁剪表",
      no_permission: "你没有维护裁剪表的权限。",
    },
    list: {
      status: "状态",
      selected: "已勾选",
      ...
      tailoring: "裁剪表",
      updated_at: "更新",
      axis_meta: "{reviews} 个评审 × {products} 个产品",
      axis_empty: "还没挑评审和产品",
      sub_pending: "第 {round} 轮 · {approved} / {total} 已通过 · {rule}",
      sub_approved: "第 {count} 次生效 · {date} · 生成 {generated} 条评审",
      sub_revising: "上次生效 {date}",
      sub_revising_changes: "改了 {count} 格未提交",
      today_at: "今天 {time}",
      copy_link: "复制链接",
      link_copied: "链接已复制",
    },
    ...
    steps: {
      heading: "建好之后",
      pick_reviews: "挑评审",
      pick_reviews_hint: "纵轴 · 按评审整块加",
      add_products: "添加产品",
      add_products_hint: "横轴 · 本项目的产品",
      select: "勾选并签批",
      select_hint: "不做的格子写原因",
    },
    kind: {
      process: "过程评审裁剪",
      o_stage: "O阶段评审裁剪",
    ...
    form: {
      create_title: "新建裁剪表",
      title_label: "标题",
      title_placeholder: "例如：I 阶段裁剪表、量产前裁剪表",
      title_required: "标题不能为空",
      kind_label: "裁剪类型",
      kind_required: "请选择裁剪类型",
      kind_hint_process: "纵轴只能加过程评审与评审活动，不含 O 阶段",
      kind_hint_o_stage: "纵轴只能加 O 阶段评审与 O 阶段评审活动",
      kind_locked: "裁剪类型创建后不可更改",
      description_label: "描述",
      optional: "选填",
      submit: "创建",
      description_placeholder: "这张裁剪表的背景与说明（选填）",
      save_failed: "保存失败",
    },
    detail: {
      ...
      filtered_empty_stage: "这个阶段下没有行",
      filter_all: "全部",
      filter_cut: "裁剪",
      filter_missing: "待补原因",
      add_axes: "添加评审 / 产品",
      description_save_hint: "或点空白处保存",
      description_saved: "已保存",
      description_expand: "展开全部",
      description_collapse: "收起",
    },
    matrix: {
      title: "裁剪矩阵",
      ...
      reason_missing: "缺少裁剪原因",
      reason_save: "保存原因",
      completed_will_delete: "这条评审已评审，改为裁剪并签批后会连同轨迹、评论、附件一起删除",
      locked_disabled: "模板已停用，不能改为保留",
      save: "保存裁剪",
      rows_count: "{count} 行",
      product_range: "产品 {from}–{to} / {total}",
      prev_column: "上一列",
      next_column: "下一列",
      write_reason: "补充裁剪原因",
      ...
      remove_column: "移除这一列",
      remove_row: "移除",
      unsaved_count: "{count} 处改动还没保存",
      discard: "放弃改动",
      empty_products_title: "还没有添加产品",
      empty_products_description: "裁剪矩阵的横轴是产品。把要对比的产品加进来，就能逐格设置保留或裁剪了。",
      empty_reviews_title: "还没有挑选评审",
      empty_reviews_description: "裁剪矩阵的纵轴是评审。只把这个项目真正涉及的评审加进来 —— 没加进来的不占行，也不用写裁剪原因。",
      row_cut_count: "{count} 裁剪",
      summary: "{kept} 保留 · {cut} 裁剪",
      summary_missing: "{count} 待补原因",
      selected_count: "已选 {count} 格",
      keep_all: "全部保留",
      cut_all: "全部裁剪",
    ...
    items: {
      ...
      created_by: "创建人",
      created_at: "创建时间",
      filter_all_products: "全部产品",
      bulk_reason: "填写原因",
      bulk_reason_title: "填写裁剪原因",
      bulk_reason_apply: "应用到 {count} 项",
      bulk_reason_scope: "写到其中 {count} 个裁剪项",
      bulk_reason_overwrite: "{count} 个已有原因会被覆盖",
      bulk_reason_skip: "保留项不需要原因，自动跳过",
      selected_count: "已选 {count} 条",
      select_all_count: "选择全部 {count} 条",
      select_all_rows: "全选",
      select_row: "选中此行",
      empty: "没有匹配的明细",
    },
    approval: {
      ...
      submit_title: "提交签批",
      approvers: "签批人",
      approvers_help: "签批人必须是本项目的成员",
      approvers_required: "请至少选择一名签批人",
      rule: "通过规则",
      any: "任一通过",
      all: "全部通过",
      rule_any: "任一通过",
      rule_all: "全部通过",
      rule_n_of_m: "{count} 人通过",
      approve: "通过",
      reject: "驳回",
      withdraw: "撤回签批",
      comment_placeholder: "签批意见（选填）",
      status_waiting: "待签批",
      status_approved: "已通过",
      status_rejected: "已驳回",
      summary_selected: "保留",
      summary_after: "生效后生成",
      summary_after_unit: "条评审",
      summary_missing: "缺原因",
      summary_fix: "去补齐 →",
      completed_delete_warning: "有 {count} 条已评审的评审会在签批生效后被删除，连同轨迹、评论、附件，不可恢复",
      missing_block: "还有 {count} 格没写裁剪原因",
      add_approver: "添加签批人…",
      ...
      tab_pending: "待我签批",
      tab_done: "我已签批",
      empty_pending: "没有等你签批的裁剪表",
      empty_done: "你还没有签过",
      select_hint: "从左侧选一张裁剪表",
      inbox_item_meta: "{name} 提交 · 第 {round} 轮",
      auto_next: "签完自动切到下一张",
      sign: "签批",
      view: "签批详情",
      pending_for_you: "待你签批",
      submitted_meta: "{name} 提交于 {date} · 第 {round} 轮签批",
      open_tailoring: "打开裁剪表",
      impact_title: "通过后立即生效",
      impact_kept: "保留",
      impact_kept_hint: "{products} 个产品 · {rows} 行",
      impact_cut: "裁剪",
      impact_cut_done: "原因都已写齐",
      impact_cut_missing: "{count} 格缺原因",
      impact_after: "生效后评审",
      impact_after_hint: "新建 {created} 条 · 删除 {deleted} 条",
      impact_moved: "移动",
      impact_moved_hint: "评审跟着换阶段，id 不变",
      impact_moved_skip: "{count} 条已评审，将跳过",
      changes_title: "改动明细",
      changes_all: "全部",
      change_add: "新增",
      change_cancel: "取消",
      change_move: "移动",
      change_will_skip: "已评审，将跳过",
      progress_title: "签批进度",
      you_short: "你",
      waiting_you: "等待你的结论",
      my_decision: "你的结论",
      approve_hint: "达到规则后裁剪表立即生效",
      reject_hint: "退回提交人修改",
      confirm_approve: "确认通过",
      confirm_reject: "确认驳回",
      choose_first: "请先选择结论",
      acted_approved: "你已通过 · {date}",
      acted_rejected: "你已驳回 · {date}",
      not_approver: "你不是本轮签批人，仅可查看",
      ended: "本轮签批已结束",
    },
    actions: {
      revise: "开始修订",
      cancel_revision: "取消修订",
      cancel_revision_title: "取消修订",
      cancel_revision_content: "会把勾选与裁剪原因还原到上次生效时的状态，修订期间的改动全部丢弃。",
      add_products: "添加产品",
      add_reviews: "添加评审",
      add_reviews_empty_process: "本项目的阶段里没有可加的过程评审或评审活动",
      add_reviews_empty_o_stage: "本项目的阶段里没有可加的 O 阶段评审或 O 阶段评审活动",
      add_reviews_activity_count: "{count} 个活动",
      add_reviews_search: "搜索评审或活动名称",
      add_reviews_in_matrix: "已在表中",
      add_reviews_inactive: "已停用",
      add_reviews_no_match: "没有匹配的评审",
      add_products_search: "搜索产品名称或编码",
      add_products_in_matrix: "已在表中",
      add_products_no_match: "没有匹配的产品",
      ...
      delete: "删除裁剪表",
      delete_title: "删除裁剪表",
      delete_content: "删除后不可恢复。已生效的裁剪表不能删除。",
      add_axes_title: "添加评审与产品",
      add_axes_reviews: "评审",
      add_axes_products: "产品",
      add_axes_picked: "已选 {count}",
      add_axes_stage_count: "{count} 个可加",
      ...
      add_axes_col_product: "产品",
      add_axes_select_all: "全选",
      add_axes_clear_all: "取消全选",
      add_axes_summary: "{reviews} 个评审 · {activities} 个活动 → {rows} 行 · {products} 个产品 → 新增 {cells} 格",
      add_axes_summary_reviews: "{reviews} 个评审 · {activities} 个活动 → {rows} 行 → 新增 {cells} 格",
      add_axes_summary_products: "{products} 个产品 → 新增 {cells} 格",
      add_axes_apply: "添加 {rows} 行 · {products} 个产品",
      add_axes_apply_reviews: "添加 {rows} 行",
      add_axes_apply_products: "添加 {products} 个产品",
    },
    activity: {
      title: "变更历史",
      empty_title: "还没有变更记录",
      empty_description: "建表、保留与裁剪、签批与生效都会记在这里。",
      system: "系统",
      filter_all: "全部",
      filter_status: "状态",
      filter_edits: "修改",
      created: "创建了裁剪表",
      title_changed: "把标题从 {old} 改为 {new}",
      description_changed: "更新了描述",
      products_added: "添加了 {count} 个产品",
      reviews_added: "添加了 {count} 个评审",
      products_removed: "移除了 1 个产品",
      reviews_removed: "移除了 1 个评审",
      items_synced: "同步矩阵：新增 {added} 格，移除 {removed} 格",
      and_more: "等 {count} 项",
      cell_keep: "保留了",
      cell_cut: "裁剪了",
      cell_reason: "更新了裁剪原因",
      cells_changed: "修改了 {count} 格",
      count_keep: "保留 {count}",
      count_cut: "裁剪 {count}",
      count_reason: "原因 {count}",
      count_move: "移动 {count}",
      cell_move: "移动了",
      action_move: "移动",
      action_keep: "保留",
      action_cut: "裁剪",
      action_reason: "原因",
      reason_cleared: "清空了原因",
      submitted: "提交了第 {round} 轮签批",
      approved_partial: "通过了签批（{value}）",
      applied: "通过了签批，裁剪表生效",
      applied_counts: "新增 {created} 条评审 · 移除 {deleted} 条",
      applied_moved: " · 移动 {count} 条",
      applied_skipped: "跳过 {count} 条移动：{items}（签批时已评审）",
      rejected: "驳回了签批",
      withdrawn: "撤回了签批",
      revising: "开始修订",
      revision_cancelled: "取消了修订",
      comment: "发表了评论",
      fallback: "更新了裁剪表",
    },
    comments: {
    ...
    toast: {
      ...
      cells_saved: "裁剪已保存",
      submitted: "已提交签批",
      approved: "签批通过，裁剪表已生效",
      rejected: "已驳回",
      withdrawn: "已撤回签批",
      revising: "已进入修订",
      revision_cancelled: "已取消修订",
      axis_removed: "已从矩阵移除",
      failed: "操作失败",
      axes_added: "已添加到矩阵",
      approval_recorded: "已通过，等待其他签批人",
      approved_with_skipped: "裁剪表已生效，{count} 条移动因已评审被跳过",
    },
    move_stage: {
      menu: "移到阶段…",
      bulk: "移到阶段",
      title: "移到阶段",
      subtitle_many: "{count} 个评审活动",
      current: "当前",
      parent: "父评审「{title}」",
      col_code: "编码",
      col_stage: "阶段",
      ...
      tag_current: "当前阶段",
      tag_conflict: "已有同一活动",
      hint: "挪过去后脱离原来的父评审，直接挂在目标阶段下；以后挪回原阶段也不会自动挂回去。保留 / 裁剪和裁剪原因不变。",
      excluded: "另有 {count} 格是汇总评审或已评审，不移动",
      confirm: "移动 {count} 格",
      confirm_to: "移到 {stage} · {count} 格",
      nothing_movable: "选中的格子都不能移动：汇总评审不能挪，已评审的活动也不能挪",
      blocked_completed: "已评审，不能移动",
      moved_from: "自 {stage}",
      moved_from_tooltip: "从「{stage}」挪过来的评审活动",
      moved_to_prefix: "已移至",
      stat_moved: "移动",
      skipped_title: "修订已生效，{count} 条移动被跳过",
      skipped_item: "仍在 {stage}（原计划挪到 {target}），签批时已评审",
      skipped_dismiss: "知道了",
    },
    errors: {
      REVIEW_TAILORING_REASON_REQUIRED: "有裁剪项还没填写裁剪原因",
      REVIEW_TAILORING_TEMPLATE_DISABLED: "有勾选项来自已停用的模板",
      REVIEW_TAILORING_APPROVER_INVALID: "签批人必须是本项目的成员",
      REVIEW_TAILORING_PRODUCT_NOT_LINKED: "有产品没有关联到本项目",
      REVIEW_TAILORING_TEMPLATE_INVALID: "有评审不在本工作区的模板库里，或已被停用",
      REVIEW_TAILORING_AXIS_IN_USE: "这一行/列已经生成过评审，请走修订取消勾选",
      REVIEW_TAILORING_AXIS_NOT_FOUND: "这一行/列不在矩阵上",
      REVIEW_TAILORING_NO_CHANGES: "与上次生效相比没有任何改动",
      REVIEW_TAILORING_EMPTY: "这张裁剪表没有可提交的内容",
      REVIEW_TAILORING_NOT_EDITABLE: "当前状态不可编辑",
      REVIEW_TAILORING_NOT_PENDING: "这张裁剪表不在签批中",
      REVIEW_TAILORING_NOT_APPROVED: "只有已生效的裁剪表才能修订",
      REVIEW_TAILORING_NOT_REVISING: "这张裁剪表不在修订中",
      REVIEW_TAILORING_NOT_APPROVER: "你不是本轮的签批人",
      REVIEW_TAILORING_NOT_SUBMITTER: "只有提交人可以撤回签批",
      REVIEW_TAILORING_ALREADY_ACTED: "你已经在本轮表过态了",
      REVIEW_TAILORING_EFFECTIVE_UNDELETABLE: "已生效的裁剪表不能删除",
      REVIEW_TAILORING_PENDING_UNDELETABLE: "请先撤回签批再删除",
      REVIEW_TAILORING_NO_SNAPSHOT: "找不到生效快照，无法取消修订",
      REVIEW_TAILORING_ONLY_ACTIVITY_CAN_MOVE: "只有评审活动能移动阶段，汇总评审不能",
      REVIEW_TAILORING_STAGE_NOT_IN_PROJECT: "目标阶段不属于本项目",
      REVIEW_TAILORING_MOVE_COMPLETED: "已评审的活动不能移动阶段",
  ...
  project_stage: {
    ...
    table: {
      ...
      status: "状态",
      children: "{count} 个子阶段",
      review_count: "{count} 条评审",
      review_count_hint: "已挂评审的阶段不能删除、不能改类型",
      unassigned: "未指定",
      edit: "编辑",
      add_child: "新建子阶段",
      delete: "删除",
    ...
    footer: {
      ratio_total: "工作量占比合计",
      remaining: "还可分配 {value}%",
      leaf_only: "只统计没有子阶段的阶段",
    },
    empty: {
      title: "还没有阶段",
    ...
    form: {
      create_title: "新建阶段",
      create_child_title: "新建子阶段",
      edit_title: "编辑阶段",
      stage_type: "阶段类型",
      stage_type_required: "请选择阶段类型",
      name_placeholder: "阶段名称",
      name_hint: "左侧选阶段类型，名称默认等于类型名，可以改",
      type_locked_hint: "从研发模式带出的阶段不能改类型",
      group_hierarchy: "层级",
      parent: "父阶段",
      parent_root: "根节点（无父阶段）",
      parent_locked_hint: "创建后不可改父阶段",
      milestone: "里程碑",
      milestone_on: "是",
      milestone_off: "否",
      group_schedule: "排期",
      start_date: "计划开始",
      end_date: "计划结束",
      schedule_hint: "须落在父阶段 {start} ~ {end} 内",
      group_owner: "负责与占比",
      owner: "负责人",
      owner_placeholder: "选择负责人",
      ratio: "工作量占比",
      ratio_hint: "还可分配 {remaining}%",
      ratio_inherit_hint: "留空则继承父阶段的 {value}%（父阶段占比下移给这个子阶段）",
      ratio_parent_hint: "有子阶段的阶段占比等于子阶段之和，当前 {value}%",
      ratio_over_limit: "超出可分配的占比，最多还能填 {remaining}%",
    ...
    delete_modal: {
      title: "删除阶段「{name}」？",
      bulk_title: "删除选中的 {count} 个阶段？",
      description: "删除后不可恢复。有子阶段的阶段要先删掉子阶段。",
      confirm: "删除",
      deleting: "删除中",
    },
    bulk: {
      ...
      apply: "应用到 {count} 个阶段",
      toast_success: "已更新 {count} 个阶段",
      toast_partial: "更新了 {updated} 个，{failed} 个失败",
    ...
    toast: {
      ...
      updated: "阶段已更新",
      deleted: "阶段已删除",
      bulk_deleted: "已删除 {count} 个阶段，{failed} 个失败",
      update_error: "更新失败",
      delete_error: "删除失败",
    },
    errors: {
      project_stage_type_locked: "从研发模式带出的阶段不能改类型",
      project_stage_parent_immutable: "创建后不可改父阶段",
      project_stage_owner_not_member: "负责人必须是本项目成员",
      project_stage_name_required: "阶段名称不能为空",
      project_stage_ratio_out_of_range: "工作量占比必须在 0 到 100 之间",
      project_stage_type_workspace_mismatch: "阶段类型不属于本工作区",
      project_stage_parent_project_mismatch: "父阶段不属于本项目",
      project_stage_in_use: "这个阶段挂着评审或裁剪表里的格子，先在裁剪表把它们移到别的阶段，或删掉评审后再删",
      project_stage_type_in_use: "阶段已挂评审或裁剪格子，不能改类型",
    },
  },
  stage_review: {
    title: "阶段评审",
    ...
    detail: {
      ...
      work_instruction_placeholder: "点击添加工作指引",
      finished_goods: "成品",
    ...
    errors: {
      ...
      STAGE_REVIEW_STAGE_NOT_IN_PROJECT: "目标阶段不属于本项目",
  ...
  workspace_templates: {
    ...
    dev_modes: {
      ...
      features: {
        ...
        page_view: "页面",
        intake_view: "收件箱",
        is_time_tracking_enabled: "工时",
        is_issue_type_enabled: "工作项类型",
        review_view: "评审",
      },
      empty: {
        title: "还没有研发模式",
        description: "研发模式决定项目能用哪些组件、有哪些阶段，以及每个阶段启用哪些评审。",
        no_match_title: "没有匹配的研发模式",
        no_match_description: "换个关键词试试，或者清空搜索框。",
      },
      card: {
        preset: "预置",
        custom: "自定义",
        ...
        edit: "编辑",
        delete: "删除",
        delete_preset_blocked: "预置模式不能删除",
        delete_in_use_blocked: "已被项目引用，不能删除",
      },
      form: {
        create_title: "新建研发模式",
        edit_title: "编辑研发模式",
        ...
        name_label: "名称",
        description_label: "描述",
        description_placeholder: "这种开发方式适合什么样的项目",
        features_label: "组件开关",
        features_hint: "关掉的组件在项目里立即隐藏，数据不删。",
        preset_locked: "预置",
        create: "创建",
        save: "保存",
      },
      detail: {
        edit_mode: "编辑模式",
        preset_hint: "预置模式不能改名或删除，组件开关和阶段都可以调整。",
        features_title: "组件开关",
      ...
      table: {
        ...
        delete: "删除",
        drag_hint: "拖动调整顺序",
        drag_hint_full: "拖动把手调整顺序，松开即保存",
        ratio_total: "工作量占比合计",
        ratio_remaining: "还可分配 {value}%",
        empty_title: "这个模式还没有阶段",
        empty_description: "从阶段类型库里挑几个类型建成阶段，项目的裁剪表就按这些阶段分组。",
      },
      stage_form: {
        create_title: "新建阶段",
        edit_title: "编辑阶段",
        stage_type_label: "阶段类型",
        type_locked_hint: "阶段类型建好后不能改。要换类型请删掉这个阶段重建。",
        name_label: "阶段名称",
        name_hint: "默认等于类型名，模式内不能重名。",
        ratio_label: "工作量占比",
        days_label: "标准周期",
        days_unit: "天",
        create: "创建",
      ...
      bulk_create: {
        title: "批量新建阶段",
        hint: "勾选阶段类型，每个类型生成一个阶段，名称取类型名，默认勾满该类型下的全部评审节点。已有同名阶段的类型会跳过。",
        already_added: "已有",
        node_count: "{count} 个节点",
        confirm: "新建 {count} 个阶段",
      },
      panel: {
        title: "{name} 的评审节点",
      ...
      delete_modal: {
        title: "删除研发模式「{name}」？",
        description: "删除后不可恢复，模式下的阶段与评审勾选会一并删除。被项目引用的模式无法删除。",
        confirm: "删除",
        deleting: "删除中",
      },
      delete_stage_modal: {
        title: "删除阶段「{name}」？",
        bulk_title: "删除选中的 {count} 个阶段？",
        description: "删除后不可恢复，阶段下勾选的评审节点会一并清除。被项目裁剪表或评审实例引用的阶段无法删除。",
        confirm: "删除",
        deleting: "删除中",
      },
      toast: {
        ...
        updated: "研发模式已更新",
        deleted: "研发模式已删除",
        delete_failed: "无法删除「{name}」",
        features_updated: "组件开关已保存",
        stage_created: "阶段已创建",
        stage_updated: "阶段已更新",
        stages_created: "新建 {created} 个阶段，跳过 {skipped} 个",
        stage_deleted: "阶段已删除",
        stage_delete_failed: "无法删除阶段",
        reorder_failed: "排序保存失败",
        templates_saved: "评审勾选已保存",
      },
      errors: {
        generic: "操作失败，请稍后再试",
        name_required: "请填写模式名称",
        stage_type_required: "请选择阶段类型",
        bulk_nothing_selected: "请至少勾选一个阶段类型",
        ...
        dev_mode_system_name_readonly: "预置模式不能改名",
        dev_mode_system_protected: "预置模式不能删除",
        dev_mode_features_invalid: "组件开关格式不正确",
        dev_mode_icon_props_invalid: "图标配置格式不正确",
        dev_mode_stage_name_required: "请填写阶段名称",
        dev_mode_stage_name_already_exists: "这个模式里已有同名阶段",
        dev_mode_stage_type_workspace_mismatch: "阶段类型不属于当前工作区",
        dev_mode_stage_type_immutable: "阶段类型不能修改，请删除后重建",
        dev_mode_stage_ratio_out_of_range: "工作量占比必须在 0 到 100 之间",
        dev_mode_stage_template_mismatch: "勾选了不属于这个阶段类型的评审节点",
      },
    },
    test_cases: {
      title: "测试用例库",
  ...
  project_overview: {
    title: "项目概览",
    project_status: { active: "进行中", archived: "已归档" },
    lead: "负责人",
    lead_unassigned: "未指定",
    created_at: "创建于",
    hero: {
      completion: "完成率",
      health: "项目健康度",
      completed_of: "已完成 {completed} / {total}",
      distribution: "工作项状态分布",
      distribution_meta: "{total} 项 · 剔除已取消",
      recent_completed: "近 6 月完成",
      month_label: "{month} 月",
      rules_aria: "查看项目健康度判定规则",
      rules_title: "判定规则",
      rules_description: "综合完成率与逾期占比判定，取最严重等级。",
      rules_completion: "完成率 = 已完成 ÷（总数 − 已取消）",
      rules_overdue: "逾期占比 = 逾期未完成 ÷ 未完成数",
      levels: {
        healthy: { label: "健康", description: "进度稳定，风险可控", rule: "逾期低于 10% 且完成率不低于 50%" },
        watch: { label: "需关注", description: "存在逾期或进度偏慢", rule: "逾期达到 10% 或完成率低于 50%" },
        risk: { label: "有风险", description: "逾期较多或进度滞后", rule: "逾期达到 25%，或有未完成且完成率低于 20%" },
      },
    },
    states: { backlog: "待办", unstarted: "未开始", started: "进行中", completed: "已完成", cancelled: "已取消" },
    risks: {
      overdue: "延期工作项",
      due_soon: "7 天内到期",
      pending_defects: "待处理缺陷",
      view: "查看",
      go_defects: "去缺陷",
    },
    facts: {
      ...
      unit_count: "个",
      unit_hours: "h",
      in_progress: "{count} 进行中",
      overdue: "{count} 逾期",
      view_detail: "查看{label}详情",
    },
    products: {
      title: "关联产品",
      manage: "管理产品",
      view_all: "查看全部",
      link: "关联产品",
      columns: { product: "产品", stage: "阶段", requirements: "需求", status: "需求状态", completion: "完成率" },
      code: "代号",
      identifier: "编号",
      empty_title: "本项目还没有关联产品",
      empty_description: "需求来自产品。先把产品关联进来，才能在「需求」页引用它下面的需求。",
      error: "无法加载关联产品",
      no_permission: "没有查看关联产品的权限",
      formula: "完成率 = 已发布 ÷（总数 − 已关闭）",
    },
    ongoing: {
      title: "进行中",
      cycle: "当前迭代",
      ...
      days_left: "剩 {count} 天",
      due_today: "今天到期",
      overdue_days: "已逾期 {count} 天",
      target: "目标 {date}",
      no_date: "未设日期",
      cases: "{count} 用例",
      case_results: "通过 {success} · 失败 {fail} · 未执行 {pending}",
      empty_cycle: "没有进行中的迭代",
      empty_release: "没有进行中的发布",
      empty_test_plan: "没有进行中的测试计划",
    },
    workload: {
      title: "团队负荷",
      subtitle: "按未完成工作项",
      all_members: "全部 {count} 人",
      in_progress: "进行中",
      overdue: "已延期",
      others: "其余 {members} 人 · {items} 项未完成",
      empty: "暂无成员数据",
    },
    defects: {
      title: "缺陷",
      ...
      total: "累计",
      resolved: "已解决",
      by_priority: "待处理 · 按优先级",
      total_count: "共 {count}",
      resolve_rate: "解决率",
      priorities: { urgent: "紧急", high: "高", medium: "中", low: "低", none: "无" },
    },
    description: { title: "项目描述", expand: "展开全文", empty: "暂无项目描述", fullscreen: "全屏查看" },
    announcements: {
      title: "项目公告",
      create: "发布公告",
      fullscreen: "全屏查看",
      ...
      delete_confirm_description: "删除该公告后不可恢复，是否继续？",
      cancel: "取消",
      load_failed_title: "加载失败",
      load_failed_message: "获取公告列表失败，请稍后重试。",
      delete_failed_title: "删除失败",
      delete_failed_message: "删除公告失败，请稍后重试。",
      pagination: "第 {from}-{to} 条，共 {total} 条",
    },
    activity: { title: "项目活动", fullscreen: "全屏查看", exit_fullscreen: "退出全屏" },
    modals: {
      team_workload: "团队负荷",
      members_count: "共 {count} 人",
      member_hours: "成员工时",
  ...
  workspace_products: {
    ...
    create: {
      ...
      description_placeholder: "这个产品是什么？面向哪些客户？",
      footer_hint: "开发编号与可见性创建后仍可在产品设置中修改",
    },
    title: "产品管理",
    ...
    fields: {
      ...
      category: "产品类别",
      status: "产品状态",
      hardware_level: "硬件研发等级",
      structure_level: "结构研发等级",
      software_level: "软件研发等级",
      /** 弹窗里三个等级并排一行，语境由组名「研发等级」给出，只留限定词 */
      hardware_level_short: "硬件",
      structure_level_short: "结构",
      software_level_short: "软件",
      start_date: "启动日期",
      o_phase_close_date: "O阶段关闭日期",
      v_phase_close_date: "V阶段关闭日期",
      o_phase_close_date_short: "O 阶段关闭",
      v_phase_close_date_short: "V 阶段关闭",
      project_lead: "项目负责人",
      test_lead: "测试负责人",
      reviewers: "评审人",
      model_number: "产品型号",
    ...
    validation: {
      ...
      required: "请填写{field}",
      code_already_exists: "该项目代号已被占用，请换一个。",
      legacy_incomplete: "该产品缺少必填信息：{fields}。请补齐后再保存。",
    ...
    requirements: {
      ...
      import_modal: {
        title: "导入标准需求",
        search_tree: "搜索标准库或模块",
        no_search_result: "没有匹配的标准库或模块",
        library_tag_empty: "暂无条目",
        library_tag_drained: "已全部导入",
        includes_submodules: "含子模块",
        ...
        select_all_module: "选择「{module}」及其子模块的全部可导入条目",
        select_all_type: "选择「{type}」下的全部可导入条目",
  ...
  workspace_projects: {
    ...
    validation: {
      ...
      code_already_exists: "该项目代号已被占用，请换一个。",
      code_not_in_dictionary: "该项目代号不在数据字典中，请重新选择。",
      invalid_option: "所选项已不可用，请重新选择。",
  ...
  workspace_settings: {
    ...
    settings: {
      ...
      integrations: {
        title: "第三方集成",
        description: "查看本工作区与外部系统之间的数据对应关系，并手动触发同步。地址与密钥由运维在服务端环境变量里配置。",
        empty: "暂无已接入的第三方集成。",
        providers: {
          jiandaoyun: "简道云",
        },
        ...
        catalog: {
          jiandaoyun_project_code: {
            name: "项目代号",
            description: "从简道云「项目代号」表单拉取 proj_no，补充到数据字典「项目代号」；只新增，不删除、不改名。每天定时同步一次，也可手动触发。",
          },
        },
        card: {
          mapping: "数据对应",
          mapping_to: "数据字典「{name}」",
          target_count: "（{count} 个值）",
          target_missing: "目标字典不存在",
          config: "配置状态",
          configured: "已配置",
          not_configured: "未配置",
          missing_settings: "缺少服务端环境变量：",
          last_sync: "上次同步",
          never_synced: "尚未同步过",
          by_schedule: "定时任务",
          sync_now: "立即同步",
        ...
        summary: {
          remote_total: "远端 {count} 条",
          created: "新增 {count}",
          existing: "已存在 {count}",
          skipped: "跳过 {count}",
          local_only: "本地多出 {count}",
        },
        toast: {
          synced: "同步完成",
          load_failed: "第三方集成信息加载失败",
        },
        errors: {
          INTEGRATION_NOT_FOUND: "未找到该集成。",
          INTEGRATION_NOT_CONFIGURED: "该集成尚未配置，请联系运维在服务端补齐环境变量。",
          INTEGRATION_SYNC_IN_PROGRESS: "同步正在进行中，请稍后再试。",
          INTEGRATION_REMOTE_UNREACHABLE: "无法连接第三方系统（超时或网络不通）。",
          INTEGRATION_REMOTE_UNAUTHORIZED: "第三方系统拒绝了访问，请检查 token 与 appkey。",
          INTEGRATION_REMOTE_BAD_RESPONSE: "第三方系统返回了无法解析的数据。",
          INTEGRATION_TARGET_MISSING: "目标数据字典不存在。",
          INTEGRATION_INTERNAL_ERROR: "同步过程中发生内部错误。",
          unknown: "同步失败，请稍后再试。",
        },
      },
      stage_types: {
        title: "阶段类型",
        description: "评审模板树按阶段类型挂载。预置类型不能改编码和名称，自定义类型可随时增删，拖动把手调整顺序。",
        create: "新建阶段类型",
        table: {
          col_code: "编码",
          col_name: "名称",
          ...
          edit: "编辑",
          delete: "删除",
          delete_preset_blocked: "预置类型不可删除",
          drag_hint: "拖拽排序",
          drag_hint_full: "拖动左侧把手调整顺序，松开即保存",
          summary: "共 {total} 个类型，其中 {preset} 个预置",
        },
        empty: {
          title: "还没有阶段类型",
          description: "阶段类型是评审模板树的骨架。新建一个，或打开模板中心让系统补齐预置的 10 个。",
        },
        form: {
          create_title: "新建阶段类型",
          edit_title: "编辑阶段类型",
          code_label: "编码",
          code_hint: "工作区内唯一。预置类型占用 M010–M100，按 10 步进。",
          name_label: "名称",
          description_label: "描述",
          description_placeholder: "这个阶段用来做什么，什么情况下走这个阶段",
          preset_locked: "预置",
          preset_hint: "预置类型只能修改描述和排序。",
          create: "创建",
          save: "保存",
        },
        delete_modal: {
          title: "删除阶段类型「{name}」？",
          description: "删除后不可恢复。已被评审模板引用的类型会被拒绝删除。",
          confirm: "删除",
          deleting: "删除中…",
        },
        toast: {
          ...
          deleted: "阶段类型已删除",
          delete_failed: "无法删除「{name}」",
          reorder_failed: "排序保存失败，请稍后重试",
        },
        errors: {
          code_required: "请输入编码",
          name_required: "请输入名称",
          load_failed: "无法加载阶段类型",
          generic: "操作失败，请稍后重试",
          stage_type_code_required: "请输入编码",
          stage_type_name_required: "请输入名称",
          stage_type_code_already_exists: "该编码已存在",
          stage_type_name_already_exists: "该名称已存在",
          stage_type_system_code_readonly: "预置类型的编码不可修改",
          stage_type_system_name_readonly: "预置类型的名称不可修改",
          stage_type_system_protected: "预置类型不可删除",
          stage_type_in_use: "该阶段类型下还挂着评审模板，先在模板中心移走或删除它们。",
        },
      },
      data_dictionaries: {
        title: "数据字典",
        ...
        detail: {
          empty_selection: "从左侧选择一个字典",
          name_label: "名称",
          name_placeholder: "请输入字典名称",
          description_label: "描述",
          description_placeholder: "可选：说明该字典的用途",
          delete: "删除字典",
          system_locked: "系统字典由系统维护，不可删除",
          add_value: "添加值",
          add_value_placeholder: "输入新值，回车添加",
          delete_value: "删除值",
          no_values: "还没有值，先添加一个吧。",
          drag_hint: "拖拽排序",
          colored_toggle: "彩色显示",
          color_title: "颜色",
          custom_color: "自定义颜色",
        ...
        toolbar: {
          search_placeholder: "搜索值",
          sort_manual: "手动顺序",
          sort_name: "名称",
          sort_recent: "最近添加",
          bulk_add: "批量添加",
          drag_disabled_search: "搜索时不能拖拽排序",
          drag_disabled_sort: "切到「手动顺序」才能拖拽排序",
        },
        table: {
          col_index: "#",
          col_value: "值",
          col_usage: "引用",
          col_created: "添加时间",
          usage_products: "{count} 个产品",
          usage_projects: "{count} 个项目",
          usage_unavailable: "—",
          delete_blocked: "该值仍被产品或项目引用（含已删除或模板），无法删除",
          no_match: "没有匹配的值",
          edit_value: "编辑",
          change_color: "颜色",
        },
        ...
        bulk_modal: {
          title: "批量添加到「{name}」",
          description: "每行一个值，自动去重与去空格。",
          placeholder: "粘贴或输入多个值，每行一个",
          preview_new: "将添加 {count} 个新值",
          preview_existing: "跳过 {count} 个已存在：{labels}",
          preview_more: "…等 {count} 个",
          limit: "一次最多添加 {max} 个值",
          submit: "添加 {count} 个值",
        },
        colors: {
        ...
        create_modal: {
          title: "新建字典",
          key_label: "字典 key",
          key_placeholder: "例如 product_region",
          key_hint: "小写字母开头，仅限小写字母、数字和下划线，最多 64 个字符；创建后不可修改。",
          name_label: "名称",
          name_placeholder: "例如 产品区域",
          description_label: "描述",
          submit: "创建",
        },
        delete_modal: {
          title: "删除此字典？",
          description: "确定删除字典「{name}」及其全部值吗？此操作不可恢复。",
          confirm: "删除",
          deleting: "删除中…",
        },
        delete_item_modal: {
          title: "删除此值？",
          description: "确定删除「{label}」吗？已被产品或项目引用的值无法删除。",
        },
        toast: {
          created: "字典已创建",
          updated: "字典已更新",
          deleted: "字典已删除",
          item_created: "值已添加",
          items_bulk_created: "已添加 {created} 个值，跳过 {skipped} 个",
          item_updated: "值已更新",
          item_deleted: "值已删除",
          reordered: "排序已更新",
          failed: "操作失败，请稍后重试",
          load_failed: "无法加载数据字典",
        },
        errors: {
          key_required: "请输入字典 key",
          key_invalid: "key 须以小写字母开头，仅限小写字母、数字和下划线，最多 64 个字符。",
          key_already_exists: "该 key 已存在",
          name_required: "请输入字典名称",
          name_already_exists: "该名称已存在",
          label_required: "值不能为空",
          item_already_exists: "该值已存在",
          system_protected: "系统字典不可删除",
          item_in_use: "该值已被引用，无法删除",
        },
      },
      api_tokens: {
        title: "API 令牌",
  ...
  profile: {
    ...
    stats: {
      ...
      open_assigned_requirements: "负责的需求",
      open_assigned_requirements_description: "该成员负责且尚未发布或关闭的需求。",
      overdue_requirements: "逾期需求",
      unscheduled_requirements: "未排期需求",
      pending_requirement_approvals: "待评审需求",
      pending_requirement_approvals_description: "等待该成员评审的需求变更单。",
      overview_sections: {
        deadlines: {
          title: "期限与风险",
      ...
      focus: {
        title: "今日焦点",
        defects: "未闭环缺陷",
        defects_description: "负责人是我且尚未完成的缺陷。",
      },
      assigned_lists: {
        title: "我的待办",
        defects_title: "我负责的缺陷",
      ...
      requirements: {
        title: "我的需求",
        distribution_title: "交付分布",
        distribution_subtitle: "我负责的需求按交付状态与评审状态统计。",
        open_of_total: "条未闭环 · 共 {total} 条",
        approval_title: "评审状态",
        overdue: "逾期需求",
        unscheduled: "未排期",
        issue_completion: "关联工作项完成率",
        list_title: "我负责的需求",
        list_hint: "未闭环",
        empty: "当前没有分配给你的需求",
        all_products: "全部产品",
        page_empty_title: "还没有分配给该成员的需求",
        page_empty_description: "产品需求的负责人设为该成员后，会在这里跨产品汇总。",
      },
      workload_overview: {
        title: "负载与进度",
        state_title: "按状态分类的工作项",
        state_description: "我负责的未完成工作项状态分布。",
        open_items: "未完成",
        empty: "暂无数据",
        today_done: "今天完成",
        week_done: "本周完成",
        high_priority: "高优先级待办",
      },
      progress: {
        title: "完成进度",
