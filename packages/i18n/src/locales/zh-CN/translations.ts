...
export default {
  ...
  requirement_libraries: {
    ...
    create: "新建标准库",
    create_action: "创建",
    create_description: "标准库基于一个需求模板，库内所有标准需求共用它的字段。",
    fields: {
      name: "标准库名称",
      name_placeholder: "例如：支付域接口标准库",
      template: "需求模板",
      template_placeholder: "选择一个需求模板",
      template_hint: "创建后不可更换——换模板会让库内已填的数据全部失效。",
      description: "描述",
      description_placeholder: "可选",
      field_count: "字段数",
      requirement_count: "标准需求",
      actions: "操作",
    },
    validation: {
      name_required: "请填写标准库名称。",
      template_required: "请选择一个需求模板。",
      requirement_title_required: "请填写标准需求标题。",
    },
    empty: {
      title: "还没有需求标准库",
      description: "标准库基于一个需求模板，用来沉淀一批结构一致的标准需求。",
    },
    list: {
      search_placeholder: "搜索标准库",
      reset_view: "重置视图",
      filtered_by: "筛选：",
      clear_template_filter: "清除模板筛选",
      template_filter_fallback: "指定模板",
      updated_at: "更新时间",
      no_description: "暂无说明",
      total: "共 {count} 个标准库",
      per_page: "每页条数",
      ...
      delete_blocked: "请先清空库内的 {count} 条标准需求。",
    ...
    detail: {
      template_tooltip: "库内所有标准需求共用该模板的字段，点击查看模板",
      total: "共 {count} 条标准需求",
      empty_title: "还没有标准需求",
      empty_description: "在这里新建的标准需求，将使用「{template}」定义的字段。",
      select_all: "选择全部标准需求",
      select_requirement: "选择{name}",
      delete_selected: "删除已选（{count}）",
      delete_many_title: "批量删除标准需求？",
      delete_many_description: "确定要删除这 {count} 条标准需求吗？其明细数据将一并移除，此操作无法撤销。",
      delete_success: "已删除 {count} 条标准需求。",
      delete_requirement: "删除{name}",
      delete_title: "删除标准需求？",
      delete_description_prefix: "确定要删除“",
      delete_description_suffix: "”吗？其明细数据将一并移除，此操作无法撤销。",
      error_title: "无法加载标准需求",
    },
    requirements: {
      title: "标准需求",
      create: "新建标准需求",
      create_and_fill: "创建并填写数据",
      create_description: "将使用「{template}」的 {count} 个字段。",
      fields: {
        title: "标题",
        title_placeholder: "例如：支付下单接口",
        owner: "负责人",
        detail_count: "明细行数",
      },
    ...
    toast: {
      ...
      deleted: "需求标准库已删除。",
      failed: "操作失败，请稍后重试。",
      requirement_created: "标准需求已创建。",
      requirement_deleted: "标准需求已删除。",
      requirement_failed: "操作失败，请稍后重试。",
    },
  },
  workspace_templates: {
    title: "模板管理",
    ...
    requirements: {
      ...
      create_description: "填写模板名称后，即可继续配置自定义字段。",
      switch_template: "切换需求模板",
      active: "已启用",
      inactive: "已停用",
      delete_confirm: "确定删除此需求模板及其全部数据吗？",
      empty: {
        title: "还没有需求模板",
      ...
      list: {
        ...
        previous_page: "上一页",
        next_page: "下一页",
        select_page: "选择本页全部模板",
        select_template: "选择{name}",
        delete_template: "删除{name}",
        delete_selected: "删除已选（{count}）",
        delete_one_title: "删除需求模板？",
        delete_many_title: "批量删除需求模板？",
        delete_one_description_prefix: "确定要删除“",
        delete_one_description_suffix: "”吗？相关数据将被永久移除，此操作无法撤销。",
        delete_many_description: "确定要删除这 {count} 个需求模板吗？相关数据将被永久移除，此操作无法撤销。",
        delete_success: "已删除 {count} 个需求模板。",
        empty_filtered_title: "没有匹配的模板",
        empty_filtered_description: "请尝试其他关键词，或清空当前搜索。",
        error_title: "无法加载需求模板",
        field_count: "字段数",
        used_by: "被引用",
        used_by_count: "{count} 个标准库",
        not_used: "未被引用",
        delete_blocked: "该模板正被 {count} 个标准库使用，请先删除或改绑这些标准库。",
      },
      error: {
        title: "无法加载此需求模板",
      },
      ...
      validation: {
        name_required: "请填写模板名称。",
        required_count: "所需审批人数必须在已选审批人数范围内。",
      ...
      fields: {
        ...
        status: "状态",
        active: "允许使用",
        active_description: "启用后，可在新建需求时选择此模板。",
        description: "说明",
        description_placeholder: "说明该模板适用于什么场景以及如何使用。",
      ...
      editor: {
        ...
        preview: "预览",
        close_preview: "关闭预览",
        fields_description: "拖动字段可调整顺序；子字段仅能在所属可重复表单内排序。",
        approval_description: "设置使用此模板创建的需求由谁审批。",
        discard_confirm: "确定放弃尚未保存的模板修改吗？",
        data_loss_confirm: "此次结构调整会移除 {count} 条现有记录中的数据，仍要保存吗？",
        conflict_title: "发现更新版本",
        conflict_description: "其他人刚刚更新了此模板，已为你载入最新版本。",
        settings: "模板设置",
        settings_description: "名称、说明与模板概况。",
        overview: "模板概况",
        owner: "负责人",
        created_at: "创建于",
        updated_at: "最后更新",
        ...
        builder: {
          ...
          delete_field: "删除字段",
          copy_suffix: " 副本",
          empty_description: "从左侧字段库选择字段，开始搭建模板。",
      ...
      approval: {
        ...
        all: "全部通过",
        n_of_m: "指定人数通过",
        any_description: "任一审批人通过即可完成审批。",
        all_description: "所有已选审批人都必须通过。",
        n_of_m_description: "达到指定审批人数后完成审批。",
        approvers: "审批人",
        select_approvers: "选择审批人",
        required_count: "所需审批人数",
        required_count_description: "请输入 1 至 {count} 之间的数值。",
      },
      preview: {
        title: "字段预览",
        description: "这里展示数据页双层表头的最终效果。",
        empty: "使用此模板录入的记录会显示在这里。",
      },
      filters: {
        contains: "包含",
        equals: "等于",
      ...
      data: {
        ...
        conflict: "部分记录或模板结构已发生变化，请重新加载最新数据后继续。",
  ...
  workspace_products: {
    ...
    requirements: {
      ...
      approval: {
        unconfigured: "未配置",
        any: "任一审批人通过",
        any_description: "适合快速审批",
        all: "全部审批人通过",
        all_description: "适合严格审批",
        n_of_m: "指定最少通过人数",
        n_of_m_description: "自定义通过门槛",
      ...
      modal: {
        create_title: "新建产品需求",
        create_description: "定义需求集，从模板初始化字段与数据，并配置审批规则。",
        edit_title: "编辑产品需求",
        edit_description: "维护负责人、生命周期状态和审批规则。",
        basic: "需求信息",
        import: "模板导入",
        approval: "审批配置",
        create_and_configure: "创建并配置",
        wizard: {
          subtitle: "分步完善需求信息、初始化数据并设置审批规则。",
          progress: "产品需求创建进度",
          previous: "上一步",
          next: "下一步",
          steps: {
            ...
            approval: {
              title: "审批设置",
              description: "审批人与通过规则",
            },
          },
          blank: {
            title: "从空白需求开始",
            description: "创建完成后，可在配置页继续添加自定义字段。",
          },
          summary: {
            title: "创建摘要",
            untitled: "未命名需求",
            ...
            not_selected: "未选择",
            edit: "返回修改基本信息",
            basic_hint: "完成必填信息后，可继续选择需求的初始化方式。",
            template_hint: "创建时会将模板的字段结构复制为一套独立配置。",
          },
        },
      },
      import: {
        no_template: "不使用模板",
        fields: "导入自定义字段",
        fields_description: "复制模板的字段结构，生成一套独立配置。",
        summary: "{fields} 个自定义字段",
        excludes: "仅复制字段与数据，不继承基础信息和审批设置。",
      },
      validation: {
        title: "请输入需求名称。",
        owner: "请选择需求负责人。",
      ...
      configuration: {
        ...
        items: "配置项",
        settings: "需求设置",
        settings_description: "维护需求的基本信息、负责人及审批规则。",
        basic: "基本信息",
