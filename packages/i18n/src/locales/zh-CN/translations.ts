...
export default {
  ...
  review_tailoring: {
    ...
    activity: {
      title: "变更历史",
      empty_title: "还没有变更记录",
      empty_description: "建表、勾选、签批与生效都会记在这里。",
      created: "创建了裁剪表 {title}",
      ...
      cell_selected_on: "勾选了 {title}",
      cell_selected_off: "取消勾选 {title}",
      cell_reason: "更新了 {title} 的裁剪原因",
      submitted: "提交了第 {round} 轮签批",
      approved_partial: "签批通过（{value}）",
      applied: "签批通过，裁剪表生效：新增 {created} 条评审，移除 {deleted} 条",
      rejected: "驳回了签批",
      withdrawn: "撤回了签批",
      revising: "开始修订",
