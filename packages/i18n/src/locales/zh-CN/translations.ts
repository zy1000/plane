...
export default {
  ...
  review_tailoring: {
    ...
    detail: {
      axis_meta: "{reviews} 个评审 × {products} 个产品 · {cells} 格",
      created_by: "{name} 建于 {date}",
      submitted_by: "{name} 提交于 {date}",
      effective: "第 {count} 次生效 {date}",
      pending_changes: "本次改了 {count} 格未提交",
      ...
      stat_cut: "裁掉",
      stat_missing: "缺原因",
      stat_missing_hint: "提交前要补齐",
      stat_missing_done: "原因都写齐了",
      stat_after: "生效后",
      stat_after_hint: "生成 {created} · 删除 {deleted}",
      stat_generated: "已生成评审",
      stat_generated_unit: "条",
      only_missing: "只看缺原因",
      only_cut: "只看裁掉的",
      collapse_all: "折叠全部",
      expand_all: "展开全部",
      add_review_short: "评审",
      add_product_short: "产品",
    ...
    matrix: {
      ...
      reason_save: "保存原因",
      completed_will_delete: "这条评审已评审，取消勾选并签批后会连同轨迹、评论、附件一起删除",
      locked_disabled: "模板已停用，不能新增勾选",
      save: "保存勾选",
      rows_count: "{count} 行",
      write_reason: "写原因",
      ...
      select_row: "整行勾选 / 取消",
      select_all: "全表勾选 / 取消",
      select_column: "整列勾选 / 取消",
      select_stage: "本阶段勾选 / 取消",
      remove_column: "移除这一列",
      remove_row: "移除这一行",
      legend_cut: "裁掉 · 格里显示原因",
      legend_locked: "评审已完成，不能裁掉",
      legend_dirty: "角标 = 未保存的改动",
      unsaved_count: "{count} 处改动还没保存",
      discard: "放弃改动",
      empty_products_title: "还没有添加产品",
      empty_products_description: "裁剪矩阵的横轴是产品。把要对比的产品加进来，就能逐格勾选了。",
    ...
    actions: {
      ...
      add_products: "添加产品",
      add_reviews: "添加评审",
      add_reviews_title: "挑选要裁剪的评审",
      add_reviews_empty: "模板库里没有可加的评审了",
      add_reviews_pick_stage: "全选本阶段",
      add_reviews_clear_stage: "取消本阶段",
      add_reviews_activity_count: "{count} 个活动",
      add_reviews_apply: "添加 {count} 个评审",
      add_products_title: "添加参与产品",
      add_reviews_search: "搜索评审名称",
      add_reviews_in_matrix: "已在矩阵",
      add_reviews_inactive: "已停用",
      add_reviews_summary: "已选 {reviews} 个评审，会带入 {activities} 个活动 · 每个产品新增 {cells} 格",
      add_reviews_no_match: "没有匹配的评审",
      add_products_search: "搜索产品名称或编码",
      add_products_in_matrix: "已在矩阵",
      add_products_summary: "新增 {columns} 列 · {cells} 格",
      add_products_apply: "添加 {count} 个产品",
    ...
    errors: {
      ...
      REVIEW_TAILORING_PARENT_REQUIRED: "勾选了评审活动，必须同时勾选它所属的评审",
      ...
      REVIEW_TAILORING_TEMPLATE_NOT_ROOT: "只能整块添加评审，不能单独添加评审活动",
