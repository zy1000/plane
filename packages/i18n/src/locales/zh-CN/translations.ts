...
export default {
  ...
  requirement_libraries: {
    ...
    create: "新建标准库",
    create_action: "创建",
    create_description: "标准库基于一个需求模板，库内所有条目共用它的字段。",
    fields: {
      name: "标准库名称",
    ...
    empty: {
      title: "还没有需求标准库",
      description: "标准库基于一个需求模板，用来沉淀一批结构一致的需求条目。",
    },
    list: {
    ...
    detail: {
      template_tooltip: "库内所有条目共用该模板的字段，点击查看模板",
      error_title: "无法加载需求标准库",
    },
    items: {
  ...
  workspace_products: {
    ...
    requirements: {
      ...
      data: {
        ...
        empty: {
          title: "该需求还没有明细数据",
          description: "可以从标准库导入，或选择一个需求模板手动录入。",
        },
        toast: {
        ...
        views: {
          label: "数据视图",
          default: "默认视图",
          template_column: "所属模板",
          title_column: "标题",
          description_column: "描述",
          open_template_view: "打开「{name}」视图",
      ...
      import_modal: {
        ...
        library_meta: "{template} · {count} 条条目",
      ...
      configuration: {
        title: "需求配置",
        fields_moved_hint: "字段结构现由「模板管理 → 需求模板」维护，在这里不可修改。",
