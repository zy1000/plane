...
export default {
  ...
  review_tailoring: {
    ...
    list: {
      ...
      created_by: "创建人",
      approved_at: "生效时间",
      revision_value: "第 {count} 次",
      never_effective: "未生效",
      selected_value: "{selected} / {total}",
      axis_value: "{reviews} 个评审 · {products} 个产品",
      tailoring: "裁剪表",
      updated_at: "更新",
    ...
    matrix: {
      ...
      remove_review: "从矩阵移除这个评审",
      remove_product: "从矩阵移除这个产品",
    },
    items: {
      title: "裁剪明细",
      product: "产品名称",
    ...
    actions: {
      ...
      add_reviews_hint: "按评审整块加入，它下面的评审活动会一起进矩阵",
      ...
      add_reviews_apply: "添加 {count} 个",
      remove_review_title: "移除这个评审？",
      remove_product_title: "移除这个产品？",
      remove_axis_content: "「{name}」会连同它在矩阵里的格子一起移除，已填写的裁剪原因也会丢失。已经生成过评审的行列不能移除。",
