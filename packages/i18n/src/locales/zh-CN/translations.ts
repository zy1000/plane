...
export default {
  ...
  review_tailoring: {
    ...
    empty: {
      title: "还没有裁剪表",
      description: "新建一张裁剪表，选好阶段后勾选每个产品要做的评审。",
    ...
    form: {
      ...
      stage_label: "评审阶段",
      stage_placeholder: "选择阶段",
      stage_required: "请选择阶段",
      stage_empty: "这个工作区还没有配置任何评审模板，请先去模板中心配置。",
      stage_hint: "只列出已配置评审模板的阶段",
      products_label: "参与产品",
      products_required: "请至少选择一个产品",
      products_empty: "本项目还没有关联产品，请先去「产品」页关联。",
      select_all: "全选",
      save_failed: "保存失败",
    },
    matrix: {
    ...
    activity: {
      ...
      items_synced: "同步模板：新增 {added} 项，移除 {removed} 项",
    ...
    errors: {
      ...
      REVIEW_TAILORING_PRODUCT_REQUIRED: "请至少选择一个产品",
      REVIEW_TAILORING_STAGE_NO_TEMPLATE: "这个阶段还没有配置评审模板",
